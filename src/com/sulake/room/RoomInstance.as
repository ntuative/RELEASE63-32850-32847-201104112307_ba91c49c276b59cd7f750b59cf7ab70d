   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_246 != null)
         {
            ...
            {
               _loc3_ = this.var_246.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1336.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_578[param1] != param2)
         {
            this.var_578[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1335.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_580[param1] != param2)
         {
            this.var_580[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_579.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_579[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_147 != null)
            {
               this.var_147.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_246.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_246.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_246.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_246.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_246.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
