package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2934:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_581 = [];
         this.var_579 = [];
         events.addEventListener(RoomContentLoadedEvent.const_360,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_589,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_837,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_582 == null || this.var_482 == null)
         {
            return;
         }
         this._state = const_1718;
         if(this.var_1082 != null)
         {
            _loc1_ = this.var_1082;
            this.var_1082 = null;
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_579.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_579[_loc4_];
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_879.indexOf(_loc2_) < 0)
         {
            this.var_879.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_879.length > 0)
         {
            _loc2_ = this.var_879[0];
            this.var_879.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         var _loc8_:int = this.var_108.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_108.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_108.getKey(_loc8_);
            if(_loc9_ != null)
            {
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_582.createRoomObjectLogic(_loc6_);
