package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_356:IRoomObjectController;
      ...
      {
         if(this.var_356 == param1)
         {
            return;
         }
         if(this.var_356 != null)
         {
            this.var_356.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_356 = param1;
            this.var_356.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_356 != null)
            {
               this.var_356.setLocation(param1.loc);
               this.var_356.setDirection(param1.dir);
            }
         }
      }
   }
