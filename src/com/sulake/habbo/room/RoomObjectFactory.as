package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_887.indexOf(param1) < 0)
         {
            this.var_887.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1089.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_887.indexOf(param1);
         if(_loc3_ >= 0)
         {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1089.getValue(param1) == null)
         {
            this.var_1089.add(param1,true);
            for each(_loc2_ in this.var_887)
            {
               if(_loc2_ != null)
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1524:
               ...
               break;
            case RoomObjectLogicEnum.const_1600:
               _loc2_ = FurniturePresentLogic;
               break;
            case RoomObjectLogicEnum.const_1736:
            ...
            case RoomObjectLogicEnum.const_1575:
               ...
               break;
            case RoomObjectLogicEnum.const_1652:
            ...
            case RoomObjectLogicEnum.const_1474:
               ...
               break;
            case RoomObjectLogicEnum.const_1615:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1638.getValue(param1) == null)
            {
               this.var_1638.add(param1,true);
