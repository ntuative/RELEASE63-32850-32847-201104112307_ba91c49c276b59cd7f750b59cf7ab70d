package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1815:int = 255;
      
      private var var_1437:uint = 16777215;
      
      private var var_1813:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_543,RoomObjectMouseEvent.const_153];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1186,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_769,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_903,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_952,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_761,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1178)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1815;
            if(_loc2_ - this.var_1178 >= this.var_1814)
            {
               _loc3_ = this.var_1179;
               _loc4_ = this.var_1816;
               this.var_1178 = 0;
            }
            else
            {
               _loc7_ = this.var_1437 >> 16 & 255;
               _loc8_ = this.var_1437 >> 8 & 255;
               _loc9_ = this.var_1437 & 255;
               _loc10_ = this.var_1179 >> 16 & 255;
               _loc11_ = this.var_1179 >> 8 & 255;
               _loc12_ = this.var_1179 & 255;
               _loc13_ = (_loc2_ - this.var_1178) / this.var_1814;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1813 + (this.var_1816 - this.var_1813) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_769,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_668:
               param2.setString(RoomObjectVariableEnum.const_311,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_722:
               param2.setString(RoomObjectVariableEnum.const_345,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_673:
               param2.setString(RoomObjectVariableEnum.const_331,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_582:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_249)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_810:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1151,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1043:
               param2.setNumber(RoomObjectVariableEnum.const_903,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1075:
               param2.setNumber(RoomObjectVariableEnum.const_952,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_761,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1251,int(param1.bgOnly));
         this.var_1437 = this._color;
         this.var_1813 = this.var_1815;
         this.var_1179 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_530,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1599,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1593,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1536,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_530,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_172 || _loc12_ == RoomPlaneData.const_304)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
