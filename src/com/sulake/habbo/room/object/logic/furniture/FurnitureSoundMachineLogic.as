package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_560,RoomObjectFurnitureActionEvent.const_502,RoomObjectFurnitureActionEvent.const_453,RoomObjectFurnitureActionEvent.const_542];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2199)
         {
            this.var_2199 = _loc3_;
            if(_loc3_ == 1)
            {
