package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_477,RoomObjectFurnitureActionEvent.const_567,RoomObjectFurnitureActionEvent.const_461,RoomObjectFurnitureActionEvent.const_512,RoomObjectWidgetRequestEvent.const_158];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_715) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_535,RoomWidgetInfostandExtraParamEnum.const_881);
            ...
            if(_loc4_ != this.var_2199)
            {
               this.var_2199 = _loc4_;
               if(_loc4_ == 1)
               {
