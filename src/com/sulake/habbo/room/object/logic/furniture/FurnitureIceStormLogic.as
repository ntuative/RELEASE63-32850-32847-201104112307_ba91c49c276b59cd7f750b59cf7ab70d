   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2145 = param1.extra;
            this.var_1078 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1078 > 0 && param1 >= this.var_1078)
         {
            this.var_1078 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1611,String(this.var_1611),this.var_2145);
