package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_227[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         if(!this.var_1833)
         {
            _loc6_ = param2 / this.var_429;
            param2 %= this.var_429;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_429 == 1)
            {
               param2 = this.var_429 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
            ...
            {
               _loc3_ = this.var_227[_loc5_] as AnimationFrameSequenceData;
               if(_loc3_ != null)
               {
         ...
         _loc5_ = this.var_227.length * Math.random();
         _loc3_ = this.var_227[_loc5_] as AnimationFrameSequenceData;
      ...
      {
         if(param2 < 0 || param2 >= this.var_227.length)
         {
            return null;
         }
         var _loc5_:AnimationFrameSequenceData = this.var_227[param2] as AnimationFrameSequenceData;
         if(_loc5_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            {
               if(param3 == this.var_227.length - 1 && param4 == param2.frameCount - 1)
               {
                  _loc13_ = true;
               }
            }
