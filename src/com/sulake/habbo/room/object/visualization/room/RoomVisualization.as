package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1613:int = 16777215;
      ...
      private static const const_985:int = 10066329;
      
      private static const const_987:int = 10066329;
      
      public static const const_1549:int = 16777215;
      
      public static const const_1470:int = 13421772;
      
      public static const const_1501:int = 10066329;
      ...
      private var var_1523:String = null;
      
      private var _floorType:String = null;
      
      private var var_1527:String = null;
      
      private var var_2377:String = null;
      
      private var var_1146:uint = 16777215;
      
      private var var_2379:int = 255;
      
      private var var_2375:int = 255;
      
      private var var_2381:int = 255;
      
      private var var_1744:Boolean = true;
      
      private var var_1743:int = 0;
      
      private var var_2010:int = -1000;
      
      private const const_2043:int = 250;
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_123 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1186);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_172)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_123,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_304)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1502)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_123,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_304)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2010 + this.const_2043 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_344.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1744)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2381 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2375 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2379 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1798)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1432 || _loc3_.y != this.var_2376 || _loc3_.z != this.var_2374 || param1.scale != this.var_2378))
            {
               this.var_1432 = _loc3_.x;
               this.var_2376 = _loc3_.y;
               this.var_2374 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1151);
            if(_loc3_ != this.var_2377)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2377 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_769));
            if(_loc4_ != this.var_1146)
            {
               this.var_1146 = _loc4_;
               this.var_2381 = this.var_1146 & 255;
               this.var_2375 = this.var_1146 >> 8 & 255;
               this.var_2379 = this.var_1146 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1251));
            if(_loc5_ != this.var_1744)
            {
               this.var_1744 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_171 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_345);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_311);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_331);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_903));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_952));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_761));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_138.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_123 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc8_ < this.var_504.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_138.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_123 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_123 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_249)
                              {
