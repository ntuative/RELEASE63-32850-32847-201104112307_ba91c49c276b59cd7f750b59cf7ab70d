package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1664:int = const_394;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_357[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = this.var_357[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_357[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         {
            _loc11_ = this.var_357[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         {
            case const_283:
               _loc10_ = this.include(this.var_32,_loc8_);
               break;
            case const_251:
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_645);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_645,this.var_32.width,this.var_645);
         }
      ...
      private function include(param1:BitmapData, param2:Array) : int
      {
         if(param2 == null || param2.length == 0 || param1 == null)
         {
            return 0;
         ...
         {
            _loc4_ = this.var_357[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
