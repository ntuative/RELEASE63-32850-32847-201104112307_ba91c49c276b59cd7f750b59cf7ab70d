package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.var_32 == null)
         {
            this.var_32 = new BitmapData(this.var_267,param1,true,16777215);
         }
      ...
      {
         if(this.var_34.length == 0 || this.var_32 == null)
         {
            return;
         }
      ...
      private function include(param1:IVector3d) : void
      {
         if(this.var_34.length == 0 || this.var_32 == null)
         {
            return;
