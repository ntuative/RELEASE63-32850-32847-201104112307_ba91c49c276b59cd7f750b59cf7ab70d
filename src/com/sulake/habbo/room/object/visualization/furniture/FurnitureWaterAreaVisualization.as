package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1379:String = "shore";
      ...
      {
         if(this.var_2505 == param1 && this.var_2506 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1379)
            {
               this.var_1802 = _loc2_;
               this.var_2505 = param1;
               this.var_2506 = direction;
               return this.var_1802;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1171.indexOf(_loc2_) < 0)
            {
               this.var_1171.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1803 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_426.length)
         {
            if(this.var_426[_loc5_] == true)
            {
               this.var_1803 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_514 == 0 || this.var_630 == 0)
         {
            ...
            this.var_514 = _loc2_.getNumber(RoomObjectVariableEnum.const_332);
            this.var_630 = _loc2_.getNumber(RoomObjectVariableEnum.const_428);
         }
         this.var_426 = [];
         this.var_629 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_514 * 2 + this.var_630 * 2)
         {
            this.var_426.push(false);
            this.var_629.push(ShoreMaskCreatorUtility.const_79);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_72,getSize(param3),this.var_426,this.var_629,assetCollection);
      }
