package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1542:String = "plane";
      ...
      private var var_2621:Number;
      
      private var _direction:Vector3D;
      
      private var var_984:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_983 = 0;
         this.var_994 = false;
         this.init(0,0,0,this._direction,this.var_2621,this.var_984,this.var_2618,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1201.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_994 = true;
         if(this.var_983 < this.var_1467)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2622)
         {
            switch(this.var_2619)
            {
               case const_1706:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_984,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_362.push(_loc4_);
            ++this.var_983;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1201.length);
         return this.var_1201[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_983 < this.var_1467)
         {
            if(this.age % this.var_2620 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_983 < this.var_1467)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_261) * this.x - (1 - this.var_261) * this.lastX;
            this.y = (2 - this.var_261) * this.y - (1 - this.var_261) * this.lastY + this.var_1891 * this.var_984 * this.var_984;
            this.z = (2 - this.var_261) * this.z - (1 - this.var_261) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         var _loc1_:* = [];
         for each(_loc2_ in this.var_362)
         {
            _loc2_.update();
            _loc3_ = _loc2_.x;
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_261) * _loc2_.x - (1 - this.var_261) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_261) * _loc2_.y - (1 - this.var_261) * _loc2_.lastY + this.var_1891 * this.var_984 * this.var_984;
            _loc2_.z = (2 - this.var_261) * _loc2_.z - (1 - this.var_261) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_362.splice(this.var_362.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
