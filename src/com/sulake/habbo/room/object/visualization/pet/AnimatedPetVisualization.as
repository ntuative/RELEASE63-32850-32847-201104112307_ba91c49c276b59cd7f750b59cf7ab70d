package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1036:int = 1000;
      
      private static const const_1448:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1448) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_387 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2822)
            {
               this.var_2822 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_171)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_260);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_147);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_260);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_147);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1633 = _loc3_.getNumber(RoomObjectVariableEnum.const_390) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_208);
            if(!isNaN(_loc8_))
            {
               this.var_2031 = _loc8_;
            }
            else
            {
               this.var_2031 = direction;
            }
            this.var_1392 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2337 = _loc3_.getNumber(RoomObjectVariableEnum.const_662);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_900);
            if(_loc9_ != this.var_2030)
            {
               this.var_2030 = _loc9_;
               this.var_2823 = this.var_2030.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_387 != null)
         {
            ...
            if(this.var_1392 > 0)
            {
               _loc2_ = param1 - this.var_1392;
               if(_loc2_ < const_1036)
               {
                  this.var_387.alpha = int(Math.sin(_loc2_ / const_1036 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_387.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_387.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param2 != this.var_1343)
         {
            ...
            this.setAnimationForIndex(const_1451,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2823);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_645)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_494.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_494[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2031);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_90,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1449)
            {
