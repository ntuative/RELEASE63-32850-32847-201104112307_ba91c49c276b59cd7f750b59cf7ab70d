package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1091:BitmapData = null;
      
      private var var_1092:BitmapData = null;
      ...
      {
         this.var_314 = param2 as IHabboCommunicationManager;
         if(this.var_314 == null)
         {
            return;
         }
         this._connection = this.var_314.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2174 = this._config.getKey("interstitial.enabled","OfficialRoomListCtrl") == "true";
         this.var_2173 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2172 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1640 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1090 == 0)
         {
            this.var_1090 = getTimer();
            return false;
         }
         if(this.var_1640 > 0 && this.var_1641 >= this.var_1640)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1090;
         if(_loc1_ > this.var_2173)
         {
            ++this.var_1641;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1347 = _loc2_.imageUrl;
         this.var_2175 = _loc2_.clickUrl;
         this.var_1090 = getTimer();
         if(this.var_1347 != "")
         {
            ...
            {
               this.var_219 = new Timer(this.var_2172,1);
            ...
            this.var_219.start();
            _loc4_ = new URLRequest(this.var_1347);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_496,0,0,param1.bitmapData,this.var_2175));
            this.var_1090 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1346 = _loc2_.imageUrl;
         this.var_1639 = _loc2_.clickUrl;
         if(this.var_1346 != "" && this.var_1639 != "")
         {
            _loc3_ = this.var_1346;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1346);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_592,0,0,_loc4_,_loc2_.assetName,this.var_1639,this.var_1091,this.var_1092));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1091 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1092 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_589.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_589.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_589.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_814,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_918,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
