package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_229:Point;
      
      private var var_794:Timer;
      ...
      {
         return this._notifications[this.var_1463];
      }
      ...
      public function dispose() : void
      {
         if(this.var_136)
         {
            ...
            this.var_136.toolbar.events.removeEventListener(HabboToolbarEvent.const_770,this.onToolbarResized);
            this.var_136 = null;
         }
         ...
         {
            this.var_794.stop();
            this.var_794.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_794 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_136.toolbar.events.addEventListener(HabboToolbarEvent.const_770,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_794 = new Timer(_loc4_);
         this.var_794.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_794.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_229.y = this.var_136.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_229.y;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_97,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1463 < this._notifications.length - 1)
         {
            ++this.var_1463;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_229);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_229,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_229.x;
            this._window.y = this.var_229.y;
            this.var_136.removeUpdateReceiver(this);
         }
      }
