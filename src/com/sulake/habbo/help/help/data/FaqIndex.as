package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_785:FaqCategory;
      ...
      public function FaqIndex()
      {
         ...
         this.var_785 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_158 != null)
         {
            ...
            {
               _loc2_ = this.var_158.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_158.getValue(param1);
         if(_loc4_ != null || !param3)
         {
            return _loc4_;
         }
         _loc4_ = new FaqCategory(param1,param2);
         this.var_158.add(param1,_loc4_);
         return _loc4_;
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_785.hasItem(param1))
         {
            this.var_785.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_158.length)
         {
            _loc4_ = this.var_158.getWithIndex(_loc3_);
      ...
      {
         if(param1 >= this.var_158.length)
         {
            return null;
         }
         return this.var_158.getWithIndex(param1);
      }
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < this.var_158.length)
         {
            _loc2_ = this.var_158.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_785.hasItem(param1))
         {
            return this.var_785.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_158.length)
         {
            _loc3_ = this.var_158.getWithIndex(_loc2_);
