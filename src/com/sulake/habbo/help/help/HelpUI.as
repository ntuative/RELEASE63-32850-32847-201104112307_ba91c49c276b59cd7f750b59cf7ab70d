package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_380 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104112301));
         this.var_152 = param5;
         this.var_120 = new Map();
         this.var_120.add(HabboHelpViewEnum.const_1739,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_207,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_473,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_298,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_266,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_379,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_701,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_265,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_120.add(HabboHelpViewEnum.const_1208,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_120.add(HabboHelpViewEnum.const_1152,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_784,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_549.length == 0 || param1 != this.var_380)
            {
               this.var_549.push(this.var_380);
            }
         }
         this.var_380 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1230:
               this.showUI(HabboHelpViewEnum.const_1152);
               break;
            case CallForHelpResultEnum.const_1041:
               this.showUI(HabboHelpViewEnum.const_1208);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_120.getValue(HabboHelpViewEnum.const_207) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_601));
      }
      ...
      {
         return this.var_120.getValue(this.var_380);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2649 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2651;
         this._window.width = _loc1_.width + this.var_2649;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_207)
         {
            return;
         }
         if(this.var_673.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_673.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_673[1],this.var_673[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_673[0],this.var_673[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_207 || this.var_549.length == 0)
         {
            return;
         }
         if(this.var_379 == null)
