   ...
   public class NameChangeView
   {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1923 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_808)
         {
            this.var_808 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_808)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_807)
         {
            this.var_807 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_807)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1058 || param1 == ChangeUserNameResultMessageEvent.var_1059)
         {
