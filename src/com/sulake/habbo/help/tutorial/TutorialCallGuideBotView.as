package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      {
         if(param1.menuId == HabboToolbarIconEnum.HELP && param1.type == HabboToolbarShowMenuEvent.const_58)
         {
            this.setToolbarIconHighlight(false);
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_35.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.HELP_ARROW,this.var_767));
      }
