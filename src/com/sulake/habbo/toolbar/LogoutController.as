package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_609:int = 46;
      
      private const const_554:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_554;
         _loc3_.y = this.const_609;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_675)
         {
            this.var_675 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
