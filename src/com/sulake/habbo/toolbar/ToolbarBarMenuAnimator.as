package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_221:Boolean = true;
      
      private static const const_1310:Number = 25;
      
      private static const const_1309:Number = 90;
      
      private static const const_995:int = 50;
      
      private static const const_1387:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_637 = new Object();
         this.var_635 = new Array();
         this.var_636 = new Array();
         super();
         this._windowManager = param1;
         this.var_1444 = param2;
         this.var_782 = new Timer(const_1310);
         this.var_782.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_354[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_995 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_995 || param1.desktop.height - param1.y < const_1387;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            this.var_354.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_635[this.var_636.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_636[this.var_635.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_636.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_636.splice(_loc3_,1);
            this.var_635.splice(_loc3_,1);
         }
         this.var_635.push(param1.name);
         this.var_636.push(param2);
         param1.addEventListener(WindowEvent.const_259,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_211,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_637[_loc3_] == null)
            {
               this.var_637[_loc3_] = new Array();
            }
            if(this.var_637[_loc3_].indexOf(param1) < 0)
            {
               this.var_637[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_354.indexOf(param1) > -1)
         {
            if(const_221)
            {
            ...
            else
            {
               ...
               this.var_354.splice(this.var_354.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_635[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_636[_loc2_];
               if(this.var_637[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_637[_loc3_].length)
                  {
                     this.repositionWindow(this.var_637[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_354.length)
         {
            _loc2_ = this._itemList[this.var_354[_loc7_]];
            if(_loc2_.active)
            {
