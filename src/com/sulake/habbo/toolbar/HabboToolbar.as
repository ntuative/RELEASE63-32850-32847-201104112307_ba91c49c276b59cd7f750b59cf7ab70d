package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1521:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_314.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_314.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","OfficialRoomListCtrl") == "true")
         {
            this.var_1521 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_128,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1185,this.method_11);
         events.addEventListener(HabboToolbarSetIconEvent.const_163,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_581,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1084,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1051,this.onHideWindowEvent);
         this._state = true;
      ...
      private function method_11(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(this._view != null && this._state)
         {
