package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_1367:Number;
      
      private var var_2229:int = 5;
      
      private var var_2230:int;
      
      private var var_159:Number;
      
      private var var_2231:XML;
      ...
      {
         return this.var_1366.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2231.elements("menu");
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1368.length)
         {
            _loc2_ = this.var_721.indexOf(this.var_1368[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_295[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1073 + _loc3_);
                  _loc3_ += this.var_1367;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_295[this.var_721.indexOf(param1)];
      }
