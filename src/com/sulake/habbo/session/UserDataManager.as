package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1292:int = 2;
      
      private static const const_1769:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1291);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_888.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_888.remove(param1);
         this.var_888.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1292);
      }
