package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1032:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1443:String = "sendAccessTokenToServer";
      
      private static const const_1442:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1443,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1442,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1032);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1032);
         }
      }
