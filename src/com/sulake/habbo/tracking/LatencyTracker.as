package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_174 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1683 = int(this.var_174.getKey("latencytest.interval"));
         this.var_1684 = int(this.var_174.getKey("latencytest.report.index"));
         this.var_2292 = int(this.var_174.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1685 > this.var_1683)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1685 = getTimer();
         this.var_599.add(this.var_1382,this.var_1685);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1382));
         ++this.var_1382;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_599 == null || this.var_225 == null)
         {
            return;
         }
         ...
         if(this.var_225.length == this.var_1684 && this.var_1684 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1686) > this.var_2292 || this.var_1686 == 0)
            {
               this.var_1686 = _loc9_;
