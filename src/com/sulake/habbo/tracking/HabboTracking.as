package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_957:uint = 11;
      ...
      private var var_195:IHabboFriendList;
      
      private var var_1077:IHabboWindowManager;
      ...
      private var var_404:FramerateTracker = null;
      
      private var var_244:LatencyTracker = null;
      
      private var var_576:LagWarningLogger = null;
      
      private var var_575:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_404 = new FramerateTracker();
         this.var_244 = new LatencyTracker();
         this.var_576 = new LagWarningLogger();
         this.var_575 = new ToolbarClickTracker(this);
         this.var_1332 = new Array(const_957);
         var _loc4_:int = 0;
         while(_loc4_ < const_957)
         {
            this.var_1332[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1506,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1500,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_758,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1077)
            {
               this.var_1077.release(new IIDHabboWindowManager());
               this.var_1077 = null;
            }
            if(this.var_304)
            {
            ...
            if(this.var_195)
            {
               ...
               {
                  Component(this.var_195).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_195).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_195).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_195).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_195).events.removeEventListener(HabboFriendListTrackingEvent.const_367,this.onFriendlistTrackingEvent);
               }
               this.var_195.release(new IIDHabboFriendList());
               this.var_195 = null;
            }
            if(this.var_136)
            {
            ...
            if(this.var_152)
            {
               ...
               {
                  this.var_152.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
            ...
            {
               this.var_292.stop();
               this.var_292.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_292 = null;
            }
      ...
      {
         this.var_1332[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_174 = IHabboConfigurationManager(param2);
         if(this.var_174)
         {
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_174;
            }
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_174;
            }
            ...
            if(this.var_174)
            {
               ...
               {
                  this.var_576.configure(this.var_174);
               }
               if(this.var_404 != null)
               {
                  this.var_404.configure(this.var_174);
               }
               if(this.var_575 != null)
               {
                  this.var_575.configure(this.var_174);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_665,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_252,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_652,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_537,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_652)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1459);
         }
         else if(param1.type == HabboHotelViewEvent.const_537)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1653);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1534);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1563);
               break;
            case HabboCommunicationEvent.const_665:
               this.trackLoginStep(HabboLoginTrackingStep.const_1480,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_252:
               this.trackLoginStep(HabboLoginTrackingStep.const_252);
               break;
      ...
      {
         this.var_1077 = IHabboWindowManager(param2);
         if(this.var_1077)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_174)
            {
               if(this.var_174.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_174.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1332)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1045);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1045,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_195 = param2 as IHabboFriendList;
         Component(this.var_195).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_195).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_195).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_195).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_195).events.addEventListener(HabboFriendListTrackingEvent.const_367,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_367:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_758,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_304.events.addEventListener(AdEvent.const_592,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_152 = param2 as IHabboToolbar;
         this.var_152.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_328)
         {
            if(this.var_1605 < 1)
            {
               if(!this.var_292)
               {
                  this.var_292 = new Timer(60000,1);
                  this.var_292.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_292.start();
               }
            }
         }
            ...
            if(this._connection)
            {
               if(this.var_404)
               {
                  ...
                  if(this._roomEngine)
                  {
                     ...
                     _loc4_ = this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_28) + this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_25);
                     _loc2_ = "Avatars: " + _loc3_ + ", Objects: " + _loc4_;
                  }
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_404.frameRate),_loc2_));
                  ++this.var_1605;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_575)
         {
            this.var_575.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_174 != null && !Boolean(this.var_174.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_478 > -1 && _loc2_ < this.var_478)
         {
            ++this.var_1607;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1607);
         }
         if(this.var_478 > -1 && _loc2_ - this.var_478 > 15000)
         {
            ++this.var_1606;
         ...
         if(this.var_243 != null)
         {
            this.var_243.update(param1,this.var_478);
         }
         if(this.var_244 != null)
         {
            this.var_244.update(param1,this.var_478);
         }
         if(this.var_404 != null)
         {
            this.var_404.trackUpdate(param1,this,this.var_478);
         }
         if(this.var_576 != null)
         {
            this.var_576.update(this.var_478);
         }
      }
   }
}
