package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_961:Array = [];
      
      private static var var_1822:int = 200;
      ...
      {
         this.var_775 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1543;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_961.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_775.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_961.length < var_1822)
         {
            ...
            param1.width = this.var_775.width;
            param1.height = this.var_775.height;
            var_961.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1438)
         {
