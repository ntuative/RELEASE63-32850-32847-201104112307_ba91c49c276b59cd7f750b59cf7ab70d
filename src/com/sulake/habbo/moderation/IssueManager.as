package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1246:String = "issue_bundle_open";
      
      public static const const_699:String = "issue_bundle_my";
      
      public static const const_1108:String = "issue_bundle_picked";
      
      public static const const_1674:int = 15000;
      ...
      private var var_2850:int = 1;
      
      private var var_2851:int;
      
      private var var_2040:Timer;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_685 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1291 = [];
         this.var_1292 = [];
         this.var_1049 = new Map();
         this.var_2851 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2040 = new Timer(const_1674,0);
         this.var_2040.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2040.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1291 = this.var_1291.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_178 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1292 = this.var_1292.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1233);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1582)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1291.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_178)
         {
            _loc6_ = this.getBundles(const_699);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1292.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2851);
            }
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_106)
         {
            ...
            {
               case const_1246:
                  if(_loc4_.state == IssueMessageData.const_178)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
