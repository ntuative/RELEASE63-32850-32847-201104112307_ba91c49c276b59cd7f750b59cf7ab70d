package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2051:String = "my_issues";
      
      private const const_2053:String = "open_issues";
      
      private const const_2052:String = "picked_issues";
      
      private const const_2091:String = "closed_issues";
      ...
      private var var_1935:IIssueBrowserView;
      
      private var var_1936:IIssueBrowserView;
      
      private var var_1937:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_268 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_268.numTabItems)
            {
               _loc5_ = this.var_268.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_268 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_268 == null || this.var_268.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_268.selector.getSelectableByName("open_issues");
         this.var_268.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_372 == _loc2_)
         {
            return;
         }
         if(this.var_372 != null)
         {
            this.var_372.visible = false;
         }
         this.var_372 = _loc2_;
         if(this.var_372 == null)
         {
         ...
         this.var_372.view.width = this.var_268.container.width;
         this.var_372.view.height = this.var_268.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2051:
               if(this.var_1935 == null)
               {
                  this.var_1935 = new MyIssuesView(this.issueManager,this,this.var_268.container);
               }
               return this.var_1935;
            case this.const_2053:
               if(this.var_1936 == null)
               {
                  this.var_1936 = new OpenIssuesView(this.issueManager,this,this.var_268.container);
               }
               return this.var_1936;
            case this.const_2052:
               if(this.var_1937 == null)
               {
                  this.var_1937 = new PickedIssuesView(this.issueManager,this,this.var_268.container);
               }
