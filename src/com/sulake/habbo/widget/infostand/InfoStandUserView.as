package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1273:TagListRenderer;
      
      private var var_135:IBorderWindow;
      
      private var var_2565:int;
      
      private const const_998:int = 5;
      
      private const const_1786:int = 7829367;
      
      private const const_1785:int = 16777215;
      
      private const const_2048:int = 2000;
      
      private const const_2047:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1273 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_54 == null || this.var_53 == null || this.var_100 == null)
         {
            return;
         }
         this.var_54.height = this.var_54.scrollableRegion.height;
         this.var_53.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_53.width,this.var_100.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_53.width < this.var_100.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         while(_loc9_ < 5)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               _loc8_.addEventListener(WindowMouseEvent.const_26,this.method_8);
            }
            _loc9_++;
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_998;
      ...
      public function method_7(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1786;
            }
            else
            {
               _loc3_.textColor = this.const_1785;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_998,this.const_2047);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_364,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_364,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1273.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.method_7(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_129);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1164:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1174:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2565 > this.const_2048 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2565 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1786;
         }
      }
