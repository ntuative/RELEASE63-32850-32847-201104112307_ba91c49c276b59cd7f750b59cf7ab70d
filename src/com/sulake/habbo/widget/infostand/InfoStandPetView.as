package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2080:int = 152;
      
      private const const_2082:int = 16;
      
      private const const_1452:int = 4;
      
      private const const_2076:uint = 14342874;
      
      private const const_2083:uint = 3815994;
      
      private const const_2071:uint = 2085362;
      
      private const const_2078:uint = 39616;
      
      private const const_2081:uint = 10513106;
      
      private const const_2077:uint = 8734654;
      
      private const const_2074:uint = 9094430;
      
      private const const_2079:uint = 6200576;
      
      private const const_2075:String = "happiness";
      
      private const const_2072:String = "experience";
      
      private const const_2073:String = "energy";
      ...
      {
         if(this.var_54 == null || this.var_53 == null || this._buttons == null)
         {
            return;
         }
         ...
         this.var_53.height = this.var_54.height + 20;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2075,param1.nutrition,param1.nutritionMax,this.const_2078,this.const_2071);
         this.updateStateElement(this.const_2072,param1.experience,param1.experienceMax,this.const_2077,this.const_2081);
         this.updateStateElement(this.const_2073,param1.energy,param1.energyMax,this.const_2079,this.const_2074);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2080,this.const_2082,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2076);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2083);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1452,_loc7_.width - 2,_loc7_.height - 2 - this.const_1452);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1452);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_487) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_54 = this.var_53.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_213 && this.var_213.getPetId() == this.var_487)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1607,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_481,this._widget.petData.ownerId);
