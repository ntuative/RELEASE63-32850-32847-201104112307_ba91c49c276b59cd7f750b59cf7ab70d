package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_411:IFrameWindow;
      
      private var var_1094:Map;
      ...
      private const const_2033:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1094 = new Map();
         this.var_336 = new Timer(this.const_2033);
         this.var_336.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1094.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_487);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1094.getValue(this.var_487) as CommandConfiguration;
      ...
      {
         this.var_1094.remove(param1);
         this.var_1094.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_794,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.setParamFlag(WindowParam.const_102,true);
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_39,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_411 == null)
         {
            ...
            this.var_411 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_411 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_411.x = 200;
            this.var_411.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_380,this.var_487));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_583,this.var_487,this.var_1648 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_583,this.var_487,this.var_1648 + " " + _loc5_);
