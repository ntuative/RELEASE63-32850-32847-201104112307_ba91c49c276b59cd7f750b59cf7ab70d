package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1805:String = "infostand_user_view";
      
      private const const_1809:String = "infostand_furni_view";
      
      private const const_1808:String = "infostand_pet_view";
      
      private const const_1807:String = "infostand_bot_view";
      
      private const const_1806:String = "infostand_jukebox_view";
      
      private const const_1804:String = "infostand_songdisk_view";
      
      private var var_1275:InfoStandFurniView;
      ...
      private var var_1029:InfoStandSongDiskView;
      
      private var var_2780:Array;
      
      private var var_1537:InfostandUserData;
      
      private var var_682:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1275 = new InfoStandFurniView(this,this.const_1809,this._catalog);
         this.var_191 = new InfoStandUserView(this,this.const_1805);
         this.var_382 = new InfoStandPetView(this,this.const_1808,this._catalog);
         this.var_457 = new InfoStandBotView(this,this.const_1807);
         this.var_1030 = new InfoStandJukeboxView(this,this.const_1806,this._catalog);
         this.var_1029 = new InfoStandSongDiskView(this,this.const_1804,this._catalog);
         this.var_1537 = new InfostandUserData();
         this.var_682 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_164 = new Timer(this.const_2068);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_72,HabboWindowStyle.const_45,HabboWindowParam.const_45,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_108,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_176,this.onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_133,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_291,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_754,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_108,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_176,this.onRoomObjectRemoved);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_133,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_291,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_754,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_380,this.var_382.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1805);
         if(this.var_164)
         {
            this.var_164.stop();
         }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1807);
         if(this.var_164)
         {
            this.var_164.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_881)
         {
            this.var_1030.update(param1);
            this.selectView(this.const_1806);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_424) != -1)
         {
            this.var_1029.update(param1);
            this.selectView(this.const_1804);
         }
         else
         {
            this.var_1275.update(param1);
            this.selectView(this.const_1809);
         }
         if(this.var_164)
         {
            this.var_164.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1808);
         if(this.var_164)
         {
            this.var_164.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_191.setTags(param1.tags,this.var_2780);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         else
         {
            ...
            this.var_191.method_7(param1.customInfo,param1.isOwnUser);
