package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2035:int = 5;
      
      private const const_2034:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_148:Function;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1097 += param1.height + this.const_2034;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1097);
         this._offsetX += param1.width + this.const_2035;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1354 != null && this.var_1354.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_148);
