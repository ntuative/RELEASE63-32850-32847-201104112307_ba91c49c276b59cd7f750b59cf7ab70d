package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1795:int = 1;
      
      private const const_1800:int = 2;
      
      private const const_1801:int = 3;
      
      private const const_1797:int = 4;
      
      private const const_2063:int = 0;
      
      private const const_2059:int = 1;
      
      private const const_2057:int = 2;
      
      private const const_2061:int = 3;
      
      private const const_2058:int = 4;
      
      private const const_2062:int = 5;
      
      private const const_1798:String = "deco_img";
      
      private const const_1799:String = "dialog_bg";
      
      private const const_2065:String = "%campaign%_dialog_bg.png";
      
      private const const_358:String = "%campaign%_gift_package.png";
      
      private const const_2060:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1516 = this.var_163.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1516 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_532,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_853,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_876,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_532,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_532:
               _loc2_ = this.const_1796;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_876:
         ...
         if(this._window && (this.var_1515 != _loc2_ || _loc3_ != this.var_188))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1515)
            {
               ...
               case this.const_1795:
                  ...
                  else if(this.var_402 == this.const_2059)
                  {
                     ...
                     _loc2_ = this.const_2060;
                  }
                  else if(this.var_402 == this.const_2057)
                  {
                  ...
                  else if(this.var_402 == this.const_2061)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_402 == this.const_2058)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_188,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_402 == this.const_2062)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2065.replace("%campaign%",this.var_188);
            this.setDecoImage(_loc5_,this.const_1799);
            _loc2_ = _loc2_.replace("%campaign%",this.var_188);
            this.setDecoImage(_loc2_,this.const_1798);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_948);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1513 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1513 == 1 ? "null" : InventoryCategory.const_148);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_686,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1514.push(new ImageDownloader(this,_assets,this.var_188,this.var_1516,param1,param2));
            return;
         }
