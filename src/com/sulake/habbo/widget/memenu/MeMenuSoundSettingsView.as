package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_968:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_498 = param1.volume;
         if(this.var_968 != null)
         {
            this.var_968.setValue(this.var_498);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_968 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_902));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_498 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1853);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1854);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_498 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1852);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1851);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_684);
         }
         else
         {
