package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2066:int = 1000;
      ...
      private var var_1015:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_208 = new Timer(this.const_2066);
         this.var_208.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_208.stop();
            this.var_208.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_208 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_189.isActive)
         {
            ...
            this.var_1014.width = _loc2_ * this.var_326;
         }
         else
         {
            this.var_1014.width = 0;
            this.var_208.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_827 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_827 == null)
            {
               return;
            }
         ...
         if(!this.var_189.isActive)
         {
            this.var_827.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_827.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1015 = this._window.findChildByName("effect_hilite");
            this.var_1015.visible = false;
         }
         this.setTimeLeft();
         this.var_1014 = this._window.findChildByName("loader_bar");
         if(this.var_1014 != null)
         {
            this.var_326 = this.var_1014.width;
            this.var_208.start();
            this.onUpdate();
         }
