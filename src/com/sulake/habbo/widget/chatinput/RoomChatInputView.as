package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1083 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2149 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1987 = this._window.findChildByName("block_text");
      ...
      private function onSend(param1:WindowMouseEvent) : void
      {
         if(!this.var_1530)
         {
            this.sendChatFromInputField(this.var_2762);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc9_ = _loc8_.split(" ");
               if(_loc9_[0] == this.var_1083 && _loc9_.length == 3 && _loc9_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_484 = "";
               }
