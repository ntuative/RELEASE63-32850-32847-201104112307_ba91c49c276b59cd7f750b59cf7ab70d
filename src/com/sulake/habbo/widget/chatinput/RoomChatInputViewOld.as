package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1285:int = 11;
      
      private static const const_616:int = 18;
      
      private static const const_960:int = 16;
      
      private static const const_1284:int = 20;
      ...
      private var var_326:Number = 600;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1083 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2149 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         ...
         this.var_406 = new Timer(10000,1);
         this.var_406.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_406.reset();
            this.var_406.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_406 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_259,this.onWindowMoved);
         this.var_1530 = true;
         this.var_484 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_616 + const_960;
         _loc1_.x = const_616;
         _loc1_.y = const_1285;
      }
      ...
      {
         this.var_326 = param1 - (const_616 + const_960);
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1083 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_484 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1284);
      }
