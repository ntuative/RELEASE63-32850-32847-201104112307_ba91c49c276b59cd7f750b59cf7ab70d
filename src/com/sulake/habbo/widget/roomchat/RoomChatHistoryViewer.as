package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1362:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_179.state = RoomChatHistoryPulldown.const_244;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1154,HabboWindowStyle.const_45,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_179.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_244);
      }
      ...
      {
         return !!this.var_423 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_179.state == RoomChatHistoryPulldown.const_422 || this.var_179.state == RoomChatHistoryPulldown.const_613;
      }
      ...
      {
         if(!this.var_423 && !this.var_1649)
         {
            this.var_423 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_179.state = RoomChatHistoryPulldown.const_422;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_617;
            }
         }
         if(this.var_179 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_422 > 0 && param2)
         {
            if(this.var_1773)
            {
               if(Math.abs(param1 - this.var_422) <= const_1169)
               {
                  return;
               }
               this.var_1773 = false;
            ...
            if(this.var_423)
            {
               ...
               _loc5_ = (param1 - this.var_422) / this.var_50.height;
               _loc3_ = this.var_617 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_422;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1362 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_617 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_617 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
