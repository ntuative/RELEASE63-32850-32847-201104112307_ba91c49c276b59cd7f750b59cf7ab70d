package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_733:String = "PLSV_ADD_SONGS";
      
      public static const const_1213:String = "PLSV_START_PLAYBACK";
      
      public static const const_585:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_585)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_454[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_454[const_733];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_454.add(const_585,_loc1_);
