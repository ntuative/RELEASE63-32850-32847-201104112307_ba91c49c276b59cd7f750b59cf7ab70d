      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_423:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_60,this.var_163,this.var_2412++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_163.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_60,this.var_163,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_60,this.var_163,this);
               }
               break;
            case RoomWidgetEnum.const_586:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_60,this.var_163,this._catalog);
               break;
            case RoomWidgetEnum.const_501:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_60,events,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_447:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_60,this.var_163,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_468:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_60,this.var_163);
               break;
            case RoomWidgetEnum.const_666:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_60,this.var_163);
               break;
            case RoomWidgetEnum.const_116:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_60,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_117:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_60,this);
               break;
            ...
            case RoomWidgetEnum.const_455:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_60,this.var_163,this._catalog);
               break;
