package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1811:int = 3;
      
      private const const_2088:uint = 4.291993382E9;
      
      private const const_2086:uint = 4.29080704E9;
      
      private const const_2085:uint = 4.285767869E9;
      
      private const const_2087:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1811;
            this._view.y = this.const_1811;
      ...
      {
         this.var_2047 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_2047.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_2047.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2048 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_2048.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_2048.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1155));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2086;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2088;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2087;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2085;
      }
   }
}
