package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1533:int = 2;
      ...
      private var var_1997:TriggerConfs;
      
      private var var_1996:ActionTypes;
      
      private var var_1995:ConditionTypes;
      
      private var var_274:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_838:RoomObjectHightLighter;
      
      private var var_136:UserDefinedRoomEventsHelp;
      
      private var var_1274:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1997 = new TriggerConfs();
         this.var_1996 = new ActionTypes();
         this.var_1995 = new ConditionTypes();
         this.var_274 = new Dictionary();
         super();
         this.var_82 = param1;
         this.var_838 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1274 = new SliderWindowController(this.var_82,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_82.assets,0,20,1);
         this.var_1274.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1274.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_838.hideAll(this.var_274);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_838.showAll(this.var_274);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1274.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1274.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1533) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1533 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1997);
         this.refreshConfigureElement(this.var_1996);
         this.refreshConfigureElement(this.var_1995);
