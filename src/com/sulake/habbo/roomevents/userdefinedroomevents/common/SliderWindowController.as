package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_616:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1150,param1);
         this.var_941 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_941);
         }
      ...
      {
         return int(this.var_1757 * (Number(param1 - this._minValue) / (this.var_1150 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1757 * (this.var_1150 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_940)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_191)
            {
               this.var_940 = false;
            }
         }
         if(!this.var_940 || param1.type != WindowEvent.const_259)
         {
            return;
         }
         if(this.var_616 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_616) * this.var_616;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_616 != 0)
            {
               _loc3_ = this.var_941 + this.var_616;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_752 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_752.width,this.var_752.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_752,this.var_752.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_753 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_753.width,this.var_753.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_753,this.var_753.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1757 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_752 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_753 = BitmapData(_loc2_.content);
      }
   }
}
