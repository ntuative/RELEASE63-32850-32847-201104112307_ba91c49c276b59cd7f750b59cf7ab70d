package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1195:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1883 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1194 = this.var_1883.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1194)
         {
            this.var_1194.procedure = this.onButtonClick;
         }
         this.var_1195 = this.var_1883.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1195)
         {
            this.var_1195.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_258 >= this.var_60.length - 1)
         {
            this.var_1195.disable();
         }
         else
         {
            this.var_1195.enable();
         }
         if(this.var_258 <= 0)
         {
      ...
      {
         ++this.var_258;
         this.var_258 = Math.min(this.var_258,this.var_60.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_258;
         this.var_258 = Math.max(this.var_258,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_60[this.var_258][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_60[this.var_258][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_60[this.var_258][1]).value;
