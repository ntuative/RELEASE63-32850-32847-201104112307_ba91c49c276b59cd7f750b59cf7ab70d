package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_976:int = 100;
      ...
      private var var_2331:IScrollbarWindow;
      
      private var var_1708:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_132 = param1;
         this.var_1708 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2331 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_132.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_976 + const_1324)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_132.getButtonImage(param1);
      ...
      public function refresh() : void
      {
         ...
         if(this.var_496 == null || _loc1_.id != this.var_496.id)
         {
            this.var_496 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_496.followingAllowed)
         {
            this.var_1708.enable();
         }
         else
         {
            this.var_1708.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_496.messages.length - const_976);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_496.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_496.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_132.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_736 || param3.type == Message.const_783 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_496.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_132.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_132.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_132.send(new FollowFriendMessageComposer(this.var_496.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_132.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_720)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1079)
         {
            return 4288269465;
         }
         return 4291611852;
