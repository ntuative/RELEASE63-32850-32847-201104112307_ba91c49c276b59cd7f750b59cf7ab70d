package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1987:int = "F".charCodeAt(0);
      
      public static const const_1834:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_795 = param1.online;
         this.var_1806 = param1.followingAllowed && param1.online;
         this.var_650 = param1.figure;
         this.var_1699 = param1.motto;
         this.var_1701 = param1.lastAccess;
         this.var_1442 = param1.categoryId;
