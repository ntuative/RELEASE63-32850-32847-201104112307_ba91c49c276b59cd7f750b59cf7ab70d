package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_386:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_230.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_230.length)
         {
            ...
            {
               this.var_230.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_230)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_230,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         return Math.ceil(this.var_230.length / const_386);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_967 * const_386;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_967 + 1) * const_386,this.var_230.length);
      }
