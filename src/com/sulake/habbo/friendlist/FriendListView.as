package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1774:String = "noconvinfo";
      
      private static const const_1773:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1397:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1397 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_954 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_245 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1397.prepare(this.var_954);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1231,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1119,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_893,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_753,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_893,false);
         ...
         this.var_1396 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1396.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_245.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1175,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_893,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1231,false);
