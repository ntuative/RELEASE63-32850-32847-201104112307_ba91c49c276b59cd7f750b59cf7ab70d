package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2860:FriendListLookAndFeel;
      
      private var var_447:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2052:OpenedToWebPopup;
      
      private var var_2316:int;
      
      var var_101:FriendCategories;
      
      private var var_392:FriendRequests;
      
      private var var_2051:AvatarSearchResults;
      ...
      {
         this.var_2860 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2051 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_688.stop();
            this.var_688.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_688 = null;
         }
         ...
         if(this.var_132)
         {
            this.var_132.release(new IIDHabboMessenger());
            this.var_132 = null;
         }
         if(this.var_174)
         {
         ...
         if(this.var_1249)
         {
            this.var_1249.release(new IIDAvatarRenderManager());
            this.var_1249 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(this.var_2052 == null)
         {
            this.var_2052 = new OpenedToWebPopup(this);
         }
         this.var_2052.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_392.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_152.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_296,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1249.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_174.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_174.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_132 = param2 as IHabboMessenger;
      ...
      {
         this.var_152 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_392 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_101.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1184,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_377,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_688)
         {
            this.var_688 = new Timer(120000);
            this.var_688.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_688.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_152.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_377);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_447.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_367));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_392.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_392.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_447.findTab(FriendListTab.const_103).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_392.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_447.findTab(FriendListTab.const_103);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2051.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_447.findTab(FriendListTab.const_103);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_851 || !this.var_392)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_851.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_392.vipLimit;
         }
         else if(this.var_851.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_392.clubLimit;
         }
         if(_loc2_ > this.var_392.limit)
         {
            this.var_392.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_162) as IBitmapWrapperWindow;
