package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private static const const_1293:int = 5;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_65.windowManager.alert("${quests.workinprogress.title}","${quests.workinprogress.text}",0,this.onAlert);
            return;
         }
         if(this.isVisible())
         {
         ...
         {
            this.var_65.send(new GetQuestsMessageComposer());
         }
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc1_:Boolean = Boolean(parseInt(this.var_65.configuration.getKey("new.identity","0")));
         var _loc2_:String = this.getDefaultCampaign();
         if(this.var_1352 == null && _loc1_ && _loc2_ != "" && this.isQuestingEnabled())
         {
            _loc3_ = int(this.questEngine.configuration.getKey("questing.startQuestDelayInSeconds","30"));
            this.var_1352 = new Timer(_loc3_ * 1000,1);
            this.var_1352.addEventListener(TimerEvent.TIMER,this.onStartQuestTimer);
            this.var_1352.start();
      ...
      {
         this.close();
         if(this.var_109 != null && this.var_109.visible)
         {
            this.var_109.findChildByName("more_info_txt").visible = false;
         }
      }
      
      public function onStartQuestTimer(param1:TimerEvent) : void
      {
         this.var_65.send(new StartCampaignMessageComposer(this.getDefaultCampaign()));
      }
      ...
      {
         return this.var_65.configuration.getKey("questing.enabled","OfficialRoomListCtrl") == "true";
      }
      ...
      private function checkTrackerClose(param1:Array) : void
      {
         ...
         {
            if(_loc2_.id == this.var_2205 && _loc2_.accepted)
            {
               return;
            }
         }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_65.getXmlWindow("Quests"));
      ...
      private function prepareTrackerWindow() : void
      {
         ...
         this.var_109 = IWindowContainer(this.var_65.getXmlWindow("QuestTracker"));
         var _loc1_:IDesktopWindow = this.var_109.desktop;
         this.var_109.x = _loc1_.width - this.var_109.width - 10;
         this.var_109.y = (_loc1_.height - this.var_109.height) / 2;
         this.var_109.findChildByName("more_info_txt").procedure = this.onMoreInfo;
         this.var_109.findChildByName("more_info_txt").mouseThreshold = 0;
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_65.getXmlWindow("QuestEntry"));
         var _loc2_:IWindowContainer = IWindowContainer(this.var_65.getXmlWindow("Campaign"));
         var _loc3_:IWindowContainer = IWindowContainer(this.var_65.getXmlWindow("Quest"));
         var _loc4_:IWindowContainer = IWindowContainer(this.var_65.getXmlWindow("EntryArrows"));
         ...
         new PendingImage(this.var_65,IBitmapWrapperWindow(_loc4_.findChildByName("arrow_0")),"quest_arrow1");
         new PendingImage(this.var_65,IBitmapWrapperWindow(_loc4_.findChildByName("arrow_1")),"quest_arrow2");
         new PendingImage(this.var_65,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_bitmap")),"quest_counterbkg");
         _loc3_.x = _loc2_.x + _loc2_.width + const_1293;
      ...
      {
         this.var_109.findChildByName("header_txt").caption = this.getQuestTitle(param1);
         this.var_109.findChildByName("desc_txt").caption = this.getQuestDesc(param1);
         this.var_109.findChildByName("more_info_txt").visible = true;
         this.var_65.localization.registerParameter("quests.tracker.progress","completedSteps","" + param1.completedSteps);
         this.var_65.localization.registerParameter("quests.tracker.progress","totalSteps","" + param1.totalSteps);
         this.setupQuestImage(this.var_109,param1);
      }
      ...
      private function onAcceptQuest(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.send(new AcceptQuestMessageComposer(_loc3_));
         this._window.visible = false;
      }
      ...
      private function onCancelQuest(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_65.send(new RejectQuestMessageComposer());
      }
      ...
      private function setupQuestImage(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         if(param2.type == QuestTypeEnum.FIND_STUFF)
         {
            ...
            _loc7_ = this.var_65.sessionDataManager.getFloorItemDataByName(_loc5_,_loc6_);
            if(_loc7_)
            {
               new PendingFurniImage(this.var_65,_loc3_,_loc7_,_loc6_);
            }
         }
         else if(param2.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            new PendingImage(this.var_65,_loc3_,"icon_quest_hidden");
         }
         else if(param2.type == QuestTypeEnum.GIVE_BADGE)
         {
            new PendingImage(this.var_65,_loc3_,"NewUserBadgeReceiver");
         }
         else
         {
      ...
      private function setupRewardImage(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         _loc3_.id = param2.id;
         new PendingImage(this.var_65,_loc3_,"quest_pixel");
      }
