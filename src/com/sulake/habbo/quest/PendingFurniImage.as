package com.sulake.habbo.quest
{
   ...
   public class PendingFurniImage implements IGetImageListener, IDisposable
   {
      ...
      public function PendingFurniImage(param1:HabboQuestEngine, param2:IBitmapWrapperWindow, param3:IFurnitureData, param4:int)
      {
         ...
         var _loc5_:ImageResult = this.var_65.roomEngine.getFurnitureImage(param3.id,new Vector3d(90,0,0),64,this,param4,"");
         this.var_2462 = _loc5_.id;
      ...
      {
         if(this.var_2462 == param1)
         {
            QuestUtils.setElementImage(this.var_1707,param2,this.var_1707.height);
            this.dispose();
         }
      }
   }
