package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1716:IAlertDialog;
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         new QuestCompleted(this.var_65,_loc2_.questData);
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.onQuests(_loc2_.quests,_loc2_.openWindow);
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         this.var_65.controller.onQuest(_loc2_.quest);
      }
      ...
      {
         this.var_65.controller.onRoomEnter();
         this.var_65.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.QUESTS));
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_65.controller.onRoomExit();
         this.var_65.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.QUESTS));
      }
   }
}
