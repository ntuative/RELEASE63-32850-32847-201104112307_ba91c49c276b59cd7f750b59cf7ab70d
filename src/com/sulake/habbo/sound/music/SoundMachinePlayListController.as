package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_69:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_69 = param2;
         this.var_719 = [];
         this.var_719.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_719.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_719)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_87,this.onSongInfoReceivedEvent);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_927,this.onSoundMachinePlayEvent);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_870,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_927,this.onSoundMachinePlayEvent);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_870,this.onSoundMachineStopEvent);
               this.var_82 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_458);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_69.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_458 = -1;
         this.var_679 = false;
         this.var_69.stop(HabboMusicPrioritiesEnum.const_122);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_69.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_69.playSong(param1,HabboMusicPrioritiesEnum.const_122,_loc3_,0,0,0))
         {
