package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1328:int = 60;
      ...
      private var var_738:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_725,this.onTraxLoadComplete);
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1233:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1708:
               ...
               case HabboSoundTypesEnum.const_1203:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1066:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_1076:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1692:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_174.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_174.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_607.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1139.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(this.var_174 == null || this._connection == null || this._roomEngine == null || this.var_69 != null)
         {
            return;
         }
         this.var_69 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_69.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1675,this.var_739));
         this.var_739 = -1;
         this.var_738 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_498 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_498 * 100)));
         }
      }
      ...
      {
         this.var_498 = param1;
         this.var_69.updateVolume(this.var_498);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_152.events.dispatchEvent(_loc2_);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_607.getValue(param1) != null)
         {
            _loc2_ = this.var_607.remove(param1);
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1140.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1328 && this.var_1140.length > 0)
            {
               _loc3_ = this.var_1140.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_607.length == 0 && this.var_739 != -1)
            {
               this.var_738.ready = true;
               _loc4_ = this.var_739;
               this.var_739 = -1;
               this.var_738 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_725,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_738 == null && this.var_1139.length > 0)
         {
            _loc1_ = this.var_1139.getKey(0);
            _loc2_ = this.var_1139.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_725,_loc1_));
               }
               else
               {
                  this.var_738 = _loc2_;
