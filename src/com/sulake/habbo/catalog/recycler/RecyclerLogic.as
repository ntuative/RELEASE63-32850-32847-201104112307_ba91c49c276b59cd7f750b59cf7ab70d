package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_625 != const_991;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1796 != RecyclerStatusMessageEvent.const_1219;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_625 == const_438;
      }
      ...
      {
         this.var_625 = const_992;
         this.var_113 = new Array(const_213);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1796)
         {
            case RecyclerStatusMessageEvent.const_1695:
               this.var_625 = const_438;
            ...
            case RecyclerStatusMessageEvent.const_1219:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1725:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1239:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1732:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_113.length < const_213)
         {
            return false;
         }
         var _loc1_:int = 0;
