package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1784:int = 1;
      
      private const const_1783:int = 2;
      
      private const const_2069:int = 40;
      
      private const const_2070:int = 10;
      
      private var var_841:Array;
      
      private var var_1549:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_558)
         {
            this.var_558.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_558 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_680)
         {
            ...
            this.var_680 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_680)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1783,_loc2_.length);
         if(!this.var_558)
         {
            this.var_558 = new Timer(25);
            this.var_558.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1283 = 0;
         this.method_5();
         this.var_558.start();
      ...
      private function method_5() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1283 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1283));
            ++this.var_1283;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_680 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_680.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1784);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2070;
                  break;
               case "search_input":
                  _loc8_ = this.const_2069;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1549.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
