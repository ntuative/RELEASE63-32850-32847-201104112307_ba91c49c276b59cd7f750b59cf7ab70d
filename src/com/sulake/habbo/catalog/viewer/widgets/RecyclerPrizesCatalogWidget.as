package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1875:XML;
      
      private var var_1874:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_646 = this.recycler.getPrizeTable();
         ...
         this.var_1874 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_646.length > 0 && this.var_646[0].prizes.length > 0)
         {
            this.select(this.var_646[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_646[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1874) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1875) as IWindowContainer;
