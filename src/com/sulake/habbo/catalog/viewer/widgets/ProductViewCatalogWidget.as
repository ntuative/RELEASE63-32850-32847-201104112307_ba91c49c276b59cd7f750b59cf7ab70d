package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1827:Point;
      
      private var var_519:IItemGridWindow;
      
      private var var_1440:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1182 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1827 = new Point(this.var_86.x,this.var_86.y);
         this.var_519 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1440 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1826 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_519 != null)
         {
            this.var_519.visible = false;
            this.var_519.destroyGridItems();
         }
         if(this.var_1440 != null)
         {
            this.var_1440.visible = false;
         }
         ...
         this.var_1182.text = _loc5_;
         this.var_962.height = this.var_962.textHeight + 5;
         this.var_1182.y = this.var_962.y + this.var_962.height;
         this.var_1182.height = Math.max(130,this.var_1182.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_571:
                  _loc6_ = this.var_1826.clone();
                  if(this.var_519 != null)
                  {
                     this.var_519.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_519,this.var_1440,this.var_1875);
                     this.var_519.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_186:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_314,AvatarAction.const_499);
                              _loc16_.appendAction(AvatarAction.const_330,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2536)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2536 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1827.x;
            this.var_86.y = this.var_1827.y;
            if(param3 != null)
            {
