package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_321:CatalogObjectMover;
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_26:
               if(this.var_321 != null)
               {
                  this.var_321.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_321 == null)
               {
                  this.var_321 = new CatalogObjectMover();
                  this.var_321.mainContainer = window;
                  this.var_321.roomEngine = _loc3_;
               }
               this.var_321.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
