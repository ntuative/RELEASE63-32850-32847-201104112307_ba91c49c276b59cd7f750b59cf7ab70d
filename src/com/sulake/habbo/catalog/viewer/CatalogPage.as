package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1755:String = "ctlg_";
       
      
      protected var var_2098:XML;
      ...
      private var var_511:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1161:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_511 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1160);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1160);
      }
      ...
      {
         var _loc2_:String = const_1755 + param1;
         ...
         this.var_2098 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2098) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1711:
               if(this.var_1161 == null)
               {
                  this.var_1161 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1161);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1744:
               ...
               break;
            case CatalogWidgetEnum.const_1700:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_511.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_511 != null)
         {
            return this.var_511.dispatchEvent(param1);
         }
         return false;
      }
