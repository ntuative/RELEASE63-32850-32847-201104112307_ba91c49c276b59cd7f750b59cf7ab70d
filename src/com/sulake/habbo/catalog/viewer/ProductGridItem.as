package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_977:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_257:IItemGrid;
      
      private var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_606:Object;
      ...
      {
         this._view.getChildByName(const_977).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_977).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_257.select(this);
            this.var_606 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_26 && this.var_606 != null && this.var_606 == param2)
         {
            _loc3_ = this.var_257.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_606 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_168)
         {
            this.var_606 = null;
         }
      }
