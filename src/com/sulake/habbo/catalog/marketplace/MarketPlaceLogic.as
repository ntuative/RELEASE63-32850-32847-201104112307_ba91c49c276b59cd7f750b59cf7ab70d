package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1276:String = "poster";
       
      
      public const const_1993:int = 1;
      
      public const const_1857:int = 2;
      
      public const const_2093:int = 3;
      ...
      private var var_226:MarketplaceConfirmationDialog;
      ...
      private var var_2130:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_242);
            this.var_242 = null;
         }
         if(this.var_291 != null)
         {
            this.disposeOffers(this.var_291);
            this.var_291 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_226)
         {
            this.var_226 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_226.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2127,this.var_2135,this.var_2132,this.var_2133);
      }
      ...
      {
         if(!this.var_242 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_242.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1993,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_291.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_291.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_520)
            {
               this.var_291.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_242.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2131 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_291.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_242.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_242.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_242.add(parser.offerId,updateItem);
            }
            this.var_242.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1857,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_291.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2129 || param1.furniTypeId != this.var_2128)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1276)
               {
                  _loc2_ = true;
               }
            }
