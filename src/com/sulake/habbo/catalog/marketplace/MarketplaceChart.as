package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_618 = 0;
         for each(_loc4_ in this.var_160)
         {
         ...
         this.var_947 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_947);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_947 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1157,(param2 - this.var_947) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1157 + this.var_1157 / -this.var_2909 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_947 - this.var_947 / this.var_618 * this.var_160[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_160 && this._x.length > 1;
      }
   }
}
