package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1072:IRoomSession;
      ...
      private var var_178:CatalogViewer;
      ...
      private var var_226:PurchaseConfirmationDialog;
      ...
      private var var_2414:Boolean = true;
      
      private var var_2415:Boolean = true;
      
      private var var_1762:Boolean = false;
      
      private var var_2416:GiftWrappingConfiguration;
      
      private var var_1151:ClubGiftController;
      
      private var var_509:ClubBuyController;
      
      private var var_757:Map;
      
      private var var_1152:Boolean = false;
      
      private var var_943:IPurchasableOffer;
      
      private var var_1418:IDragAndDropDoneReceiver;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_226 == null)
            {
               this.var_226 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_226.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_509.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_174.getKey("client.credits.embed.enabled","OfficialRoomListCtrl") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_174.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_412.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_412.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = this.var_412.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_757.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_195)));
         var _loc1_:int = 0;
      ...
      {
         this.var_152.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_823)
         {
            if(!this.var_412.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_152 != null && _loc2_)
         {
            this.var_152.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_178.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_178 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_178.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_271,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1762 = param1.session.isPrivateRoom;
               this.var_1072 = param1.session;
               if(this.var_92 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1151 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_509 == null)
         {
            this.var_509 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_178 != null)
         {
            this.var_178.catalogWindowClosed();
         }
         if(this.var_92 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_92.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_345.openPage(this.var_756);
            this.var_756 = "";
            this.var_944 = -1;
         }
         else if(this.var_944 > -1)
         {
            this.var_345.openPageById(this.var_944,this.var_1761);
            this.var_944 = -1;
            this.var_1761 = -1;
            this.var_756 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_178.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_178.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2414 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1076);
         }
         this.var_2414 = false;
         if(this.var_302 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_67,this.var_104.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2415 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1066);
         }
         this.var_2415 = false;
         if(this.var_302 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1151.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_178.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2416 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_226 != null)
         {
            this.var_226.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_757.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_757.add(_loc2_.productCode,_loc3_.slice());
            this.var_178.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_174.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_174.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_171)
         {
            _loc3_ = this.var_174.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_174.keyExists("catalog.drag_and_drop") || this.var_174.getKey("catalog.drag_and_drop") != "true")
         {
            return;
         }
         if(!this.var_1072 || !this.var_1072.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1152 && param1.type == RoomEngineObjectEvent.const_169)
         {
            this.resetPlacedOfferData();
            if(this.var_943 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_84 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_943);
            _loc2_ = this.var_1418;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_943.productContainer.firstProduct;
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_84 != null)
         {
            if(this.var_84.category == RoomObjectCategoryEnum.const_28)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_84 && this.var_84.productClassId == param1.classId)
         {
            if(this.var_84.roomCategory == this._roomEngine.activeRoomCategory && this.var_84.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_319 || param1.category == FurniCategory.const_295 || param1.category == FurniCategory.const_309)
               {
