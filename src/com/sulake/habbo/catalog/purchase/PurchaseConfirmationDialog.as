package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2055:int = 10;
      ...
      private const const_1770:uint = 4.293848814E9;
      
      private const const_1771:uint = 4.294967295E9;
      
      private const const_2056:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1604 = _loc1_.stuffTypes;
            this.var_822 = _loc1_.boxTypes;
            this.var_821 = _loc1_.ribbonTypes;
            this.var_1244 = this.var_1604[0];
            this.var_373 = this.var_822[0];
            this.var_375 = this.var_821[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_375 < 0)
         {
            this.var_375 = this.var_821.length - 1;
         }
         if(this.var_375 > this.var_821.length - 1)
         {
            this.var_375 = 0;
         }
         if(this.var_373 < 0)
         {
            this.var_373 = this.var_822.length - 1;
         }
         if(this.var_373 > this.var_822.length - 1)
         {
            this.var_373 = 0;
         }
         var _loc1_:int = this.var_822[this.var_373] * 1000 + this.var_821[this.var_375];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1244,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1504 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1604;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1244);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_822[this.var_373]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_821[this.var_375]);
         this._catalog.purchaseProductAsGift(this.var_1505,this.var_91,this.var_1503,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1505,this.var_91.offerId,this.var_1503);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               if(this.var_2701 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_230)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2055)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2701 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_364:
      ...
      {
         if(this.var_270 == null || !this.var_270.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_270.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_270 == null)
         {
            this.var_270 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_666 == null)
         {
            this.var_666 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_666.procedure = this.suggestionsEventHandler;
         }
         if(this.var_270 == null || this.var_666 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_270.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_666.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2056;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1770) : uint(this.const_1771);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_270.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1244;
               }
            }
            _loc4_++;
         }
