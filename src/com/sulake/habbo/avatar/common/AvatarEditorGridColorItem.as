package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_942:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_609 = _loc4_.content as BitmapData;
         ...
         this.var_928 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_609.width,this.var_609.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_609,this.var_609.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_929.width,this.var_929.height,true,0);
            _loc5_ = this.var_929.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_942.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_928.width,this.var_928.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_928,this.var_928.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_942)
            {
               switch(this.var_942.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_649;
                     _loc4_.visible = true;
               }
            }
            else
