package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2335 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1134 = new Dictionary();
         this.var_1709 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1134[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_1709.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1709.concat();
         for each(_loc3_ in this.var_1134)
         {
