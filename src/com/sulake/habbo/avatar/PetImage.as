package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_259:AvatarImageCache;
      
      private var var_639:int = 0;
      
      private var var_1655:int = 0;
      
      private var var_650:AvatarFigureContainer;
      
      private var var_638:Boolean;
      
      private var var_199:Array;
      
      private var var_565:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_650 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_650.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1363 = this.var_1260;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_50)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1363);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_639);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_650,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1363 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_639);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_639);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_650,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_90)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_639);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_523 = this.var_523 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_383:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1568:
                  case AvatarAction.const_1489:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_897);
         this.getCache().resetBodyPartCache(this.var_897);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1361 = this._structure.sortActions(this.var_331);
         ...
         {
            this.var_754 = this._structure.getCanvasOffsets(this.var_1361,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1361)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_402)
               {
                  this.var_898 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_338)
               {
                  this.var_898 = true;
               }
            }
