package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1436:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1437:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1258:AvatarEditorHandler;
      ...
      private var var_1518:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_975 = FigureData.const_78;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_193)
         {
            this.var_671 = new Dictionary();
            this.var_671["null"] = new FigureData(this);
            this.var_671["null"] = new FigureData(this);
            _loc2_ = this.var_671["null"];
            _loc3_ = this.var_671["null"];
            _loc2_.loadAvatarData(const_1436,FigureData.const_78);
            _loc3_.loadAvatarData(const_1437,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_546 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_731,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_236,new TorsoModel(this));
            ...
            this.var_546.add(AvatarEditorSideCategory.const_106,new WardrobeModel(this));
            this.var_546.add(AvatarEditorSideCategory.const_562,new ClubPromoModel(this));
            this.var_193 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_671[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1013.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1013.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_273 == null)
            {
               this.var_273 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_273.addChild(this._view.window);
               if(param5)
               {
                  this.var_273.center();
               }
            ...
            this.var_273.visible = !this.var_273.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_731);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_546.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_547 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1013 = this.var_547.getFigureData(AvatarType.const_130);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1258 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_671[this.var_975];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1518 != null)
         {
            ...
            this.var_1518.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1967;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1257 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1438)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1581.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_547.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_547.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1722)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1257 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1257 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_546.getValue(AvatarEditorSideCategory.const_106);
      }
