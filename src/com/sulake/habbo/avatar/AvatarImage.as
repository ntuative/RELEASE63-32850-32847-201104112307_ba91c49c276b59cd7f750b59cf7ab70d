package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1303:int = 2;
      
      private static const const_1304:String = AvatarSetType.const_37;
      ...
      protected var var_1065:Boolean;
      
      protected var var_754:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_259:AvatarImageCache;
      
      protected var var_650:AvatarFigureContainer;
      
      protected var var_565:IAvatarDataContainer;
      
      protected var var_331:Array;
      
      protected var var_47:BitmapData;
      
      private var var_897:IActiveActionData;
      ...
      private var var_2560:String = null;
      
      private var var_2558:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_650 = param3;
         this.var_259 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1304,const_1303);
         this.var_331 = new Array();
         this.var_897 = new ActiveActionData(AvatarAction.const_395);
         this.var_897.definition = this._structure.getActionDefinition(const_1305);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_650,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1655;
         if(param2 < AvatarDirectionAngle.const_1146)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_639,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_255.length == 1 && this.var_89 == this.var_2031)
         {
            return this.var_89 + this.var_523 + this.var_639 % 4;
         }
         if(this.var_255.length == 2)
         {
            for each(_loc1_ in this.var_255)
            {
               ...
               {
                  return this.var_89 + this.var_523 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_639 % 11;
                  return this.var_89 + "_" + this.var_2031 + this.var_523 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2559 || param2 != this.var_2560 || param1 != this.var_2558)
         {
            this.var_2559 = param3;
            this.var_2560 = param2;
            this.var_2558 = param1;
            this.var_1847 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1318 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1318)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_639);
         ...
         {
            if(this.var_565.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_565.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_639);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_331.push(new ActiveActionData(param1,param2,this.var_639));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_897;
         this.var_287.definition = this.var_897.definition;
         this.resetBodyPartCache(this.var_897);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_523 = "";
         this.var_255 = this._structure.sortActions(this.var_331);
         if(this.var_255 == null)
         {
            this.var_754 = new Array(0,0,0);
            if(this.var_1446 != "")
            {
               _loc1_ = true;
               this.var_1446 = "";
         ...
         {
            this.var_754 = this._structure.getCanvasOffsets(this.var_255,this._scale,this.var_89);
            for each(_loc4_ in this.var_255)
            {
               this.var_523 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_330)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1445 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1445 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1446 != this.var_523)
            {
               _loc1_ = true;
               this.var_1446 = this.var_523;
            }
         }
         this.var_1362 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1655 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_565 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_338 || _loc1_.actionType == AvatarAction.WAVE || _loc1_.actionType == AvatarAction.const_402)
               {
                  this.var_898 = true;
               }
            }
