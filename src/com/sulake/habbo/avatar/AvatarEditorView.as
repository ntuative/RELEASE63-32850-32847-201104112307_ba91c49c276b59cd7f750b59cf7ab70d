package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2057:int = 6710886;
      ...
      private var var_346:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_510:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1153 = [];
         this.var_1419 = [AvatarEditorFigureCategory.const_731,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_236,AvatarEditorFigureCategory.const_886,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_106];
         super();
         ...
         if(var_1581 == null)
         {
            ...
            var_1581 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_421 = new Timer(1000);
         this.var_421.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1419;
         }
         for each(_loc6_ in param4)
         {
            this.var_1153.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_421.stop();
            this.var_421.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_421 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1419);
         }
         if(param1.length != this.var_1153.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1153.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2417 = this.canChangeOutfit();
            this.var_421.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_346 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_346.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_346.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1153.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_346.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_346.numSelectables)
               {
                  this.var_346.getSelectableAt(_loc6_).x = this.var_346.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_346.setSelected(this.var_346.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1419;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1763 == AvatarEditorSideCategory.const_106 || this.var_2419))
         {
      ...
      {
         if(this.var_1763 == AvatarEditorSideCategory.const_106)
         {
            this.var_2419 = false;
            this.setSideContent(AvatarEditorSideCategory.const_816);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_816:
               break;
            case AvatarEditorSideCategory.const_562:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_562);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_380 = param1;
         this.var_346.setSelected(this.var_346.getSelectableByName(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_510)
         {
            ...
            this.var_510 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_510.procedure = this.stripClubDialogEventProc;
            this.var_510.center();
         }
         else
         {
