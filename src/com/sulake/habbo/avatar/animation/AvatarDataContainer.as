package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1913:Number = 1.0;
      
      private var var_1915:Number = 1.0;
      ...
      {
         super();
         this.var_1637 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2165 = parseInt(_loc2_,16);
         this.var_2164 = parseInt(_loc3_,16);
         ...
         this.var_766 = new ColorTransform(this.var_1913,this.var_1915,this.var_1914,this._alphaMultiplier);
         this.var_1088 = this.generatePaletteMapForGrayscale(this.var_2164,this.var_2165);
      }
      ...
      {
         return this.var_1088.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1088.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1088.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1088.getValue("alphas") as Array;
      }
