package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1789:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1379:IAvatarImage;
      ...
      private var var_361:IActiveActionData;
      
      private var var_408:AvatarImageBodyPartContainer;
      
      private var var_1462:String;
      
      private var var_118:AvatarImagePartContainer;
      
      private var var_2614:Point;
      ...
      private var var_2615:ByteArray;
      
      private var var_2613:ImageData;
      
      private var var_1051:PaletteMap;
      ...
      {
         if(this.var_793 == param1)
         {
            return;
         }
         if(this.var_793 == GeometryType.const_1248 && param1 == GeometryType.const_1194 || this.var_793 == GeometryType.const_1194 && param1 == GeometryType.const_1248)
         {
            this.var_793 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_361 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_361;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_361 || !this.var_361.definition))
         {
            if(this.var_361.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_361.definition.state + "." + this.var_361.actionParameter);
               _loc13_ = param2 - this.var_361.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_361.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_555)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1379.getFigure(),_loc5_,this.var_793,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_408 = _loc10_.getImageContainer(_loc4_);
         if(this.var_408 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_408 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_361);
            if(this.var_408 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_408,_loc4_);
         }
         this.var_408.offset = _loc8_;
         return this.var_408;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_793);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2614 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1639[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_920 || _loc10_ == AvatarAction.const_402;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1462 = this.var_118.bodyPartId;
               this.var_184 = this.var_118.partType;
               this.var_1889 = this.var_118.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_118.flippedPartType != this.var_184)
                     {
                        this.var_184 = this.var_118.flippedPartType;
                     }
                  }
               }
               this.var_1461 = this._scale + "_" + this.var_118.action.assetPartDefinition + "_" + this.var_184 + "_" + this.var_1889 + "_" + _loc5_ + "_" + this._frame;
               this.var_436 = this._assets.getAssetByName(this.var_1461) as BitmapDataAsset;
               if(this.var_436 == null)
               {
                  this.var_1461 = this._scale + "_std_" + this.var_184 + "_" + this.var_1889 + "_" + _loc5_ + "_0";
                  this.var_436 = this._assets.getAssetByName(this.var_1461) as BitmapDataAsset;
               }
               if(!(!this.var_436 || !this.var_436.content))
               {
                  if(this.var_118.paletteMapId > -1)
                  {
                     this.var_1051 = this._structure.renderManager.paletteManager.getPalette(this.var_118.paletteMapId);
                     if(this.var_1051 != null)
                     {
                        this.var_978 = this.var_436.content as BitmapData;
                        this.var_183 = new BitmapData(this.var_978.width,this.var_978.height);
                        this.var_2615 = this.var_1051.colorize(this.var_978.getPixels(this.var_978.rect));
                        this.var_183.setPixels(this.var_183.rect,this.var_2615);
                     }
                     else
                     {
                        this.var_183 = (this.var_436.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1462 == AvatarBodyPartType.const_236 || this.var_1462 == AvatarBodyPartType.const_1730 || this.var_1462 == AvatarBodyPartType.const_1682) && this.var_118.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_118.color.colorTransform);
                  }
                  if(this.var_118.isBlendable)
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_118.blendTransform);
                  }
                  this.var_977 = this.var_436.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_54)
                     {
                  ...
                  this.var_2613 = new ImageData(this.var_183,this.var_977,_loc7_);
                  this.var_979.push(this.var_2613);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2614.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_54)
            {
