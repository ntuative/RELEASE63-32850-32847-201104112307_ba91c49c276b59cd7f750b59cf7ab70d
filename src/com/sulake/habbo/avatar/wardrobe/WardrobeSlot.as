package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_650 && this.var_1459)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_90,this.var_975,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_797));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1459 && this.var_650 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_650 = this._controller.figureData.getFigureString();
               this.var_975 = this._controller.gender;
            ...
            case "get_button":
               if(this.var_650)
               {
                  this._controller.loadAvatarInEditor(this.var_650,this.var_975,this._controller.clubMemberLevel);
               }
         }
      }
