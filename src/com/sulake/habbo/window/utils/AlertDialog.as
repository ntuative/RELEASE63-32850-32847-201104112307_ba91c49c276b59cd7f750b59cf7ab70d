package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_1754:String = "_alert_button_list";
      
      protected static const const_510:String = "_alert_button_ok";
      
      protected static const const_955:String = "_alert_button_cancel";
      
      protected static const const_1086:String = "_alert_button_custom";
      
      protected static const const_1262:String = "header_button_close";
      
      protected static const const_1689:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1754) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_955);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_510:
                  ...
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_171,null,null);
               ...
               case const_1262:
                  if(this.var_284 != null)
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_457,null,null);
                     this.var_284(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_510:
                  ...
                  break;
               case HabboAlertDialogFlag.const_955:
                  _loc2_ = this._window.findChildByName(const_955) as IInteractiveWindow;
                  break;
