package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1453:uint = 1;
      ...
      private var var_1569:IEventDispatcher;
      
      private var var_1289:Boolean = false;
      
      private var var_2032:ProfilerOutput;
      
      private var var_1568:ProfilerAgentTask;
      
      private var var_1570:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_980 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_980);
         this.var_214 = new Array(const_445);
         ...
         {
            this.var_214[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_273 = this.var_214[const_1453];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2032)
            {
               this.var_2032 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2032.profiler = _loc3_;
            this.var_1568 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1568);
            this.var_1570 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1570);
            this.var_1289 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_214)
            {
               while(this.var_214.length > 0)
               {
                  IDisposable(this.var_214.pop()).dispose();
               }
            }
            this.var_214 = null;
            if(this.var_280)
      ...
      {
         return this.var_273.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_273.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_280[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_280[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_980.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_214[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_214[param2].getDesktopWindow();
      ...
      {
         return this.var_214[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_214[param1].getDesktopWindow().getChildAt(this.var_273.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_214[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_214[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_395.length > 0)
         {
            this.var_1569.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_445 - 1;
            while(_loc2_ >= 0)
            {
               this.var_214[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1289)
         ...
         this.var_1569.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_445)
         {
            this.var_214[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1289)
         {
         ...
         if(WindowContext.var_395.length > 0)
         {
            WindowContext.var_395.flush();
         }
         MouseCursorControl.change();
         this.var_1569.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1650,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1665,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1556,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1494,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_556,
            "style":WindowStyle.const_183,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
