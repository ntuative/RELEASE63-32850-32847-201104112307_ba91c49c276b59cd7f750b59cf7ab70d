package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_665:ItemPopupCtrl;
      ...
      private var var_1008:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_665 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_208)
            {
               this.var_208.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_208.stop();
               this.var_208 = null;
            }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1019) : uint(const_1018);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1019) : uint(const_1018);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_208 = new Timer(1000,3);
            this.var_208.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_208.reset();
         this.var_208.repeatCount = 3;
         this.var_208.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_208.currentCount));
         if(this.var_208.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1008)
         {
            this.var_1008.isSelected = false;
            this.var_1008 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1581)
            {
            ...
            this.var_665.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_471);
            this.var_665.show();
         }
         else if(param1.type == WindowMouseEvent.const_26)
         {
            this.var_665.hideDelayed();
         }
      }
         ...
         if(this.var_186.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_665.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_471);
               }
            }
            else
            {
