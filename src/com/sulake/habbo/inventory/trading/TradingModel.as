package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1518:uint = 9;
      
      public static const const_212:uint = 0;
      
      public static const const_209:uint = 1;
      
      public static const const_410:uint = 2;
      
      public static const const_320:uint = 3;
      
      public static const const_452:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_1489);
      ...
      public function close() : void
      {
         if(this.var_760)
         {
            if(this._state != const_212 && this._state != const_246)
            {
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_80);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_810 + " OTHER: " + this.var_1220);
         ...
         {
            case const_212:
               if(param1 == const_209 || param1 == const_246)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1221);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_810 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_56.alertPopup(TradingView.const_1241);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_265.length < const_1518)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_184)
            {
