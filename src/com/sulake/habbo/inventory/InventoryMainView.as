package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1594:IWindowContainer;
      
      private var var_703:String;
      
      private var var_2892:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_152 != null && this.var_1074)
         {
            this.var_152.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1074 = false;
         }
         this._controller.inventoryViewOpened(this.var_703);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_702 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_152 != null && this.var_1074)
            {
               this.var_152.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1074 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_703);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_152.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1594);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_702 == InventoryCategory.const_148)
            {
               this.toggleCategoryView(InventoryCategory.const_148);
            }
            else if(this.var_702 == InventoryCategory.const_80)
            {
