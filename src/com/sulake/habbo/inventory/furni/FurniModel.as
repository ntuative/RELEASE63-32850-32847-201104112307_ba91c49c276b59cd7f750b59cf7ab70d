package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_376:String = "pets";
      
      private static const const_1447:int = 100;
      ...
      private var var_2029:Vector.<Array>;
      
      private var var_2028:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_683 = new Timer(const_1447,1);
         this.var_683.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2821 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_683.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_683.stop();
               this.var_683 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_2029 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2029;
            }
            else
            {
               if(this.var_2028 == null)
               {
                  this.var_2028 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2028;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_80);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_295)
         {
         ...
         if(this.var_1042 == null)
         {
            this.var_1042 = this._windowManager.buildFromXML(this.var_2821) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1042.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_80 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_51:
                  ...
                  break;
               case const_376:
                  this._controller.toggleInventoryPage(InventoryCategory.const_148);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_417);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_682.add(const_46,new Array());
         this.var_682.add(const_51,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_184)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_319 || _loc3_.category == FurniCategory.const_295 || _loc3_.category == FurniCategory.const_309)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_682.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_804)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
