package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2089:int = 0;
      
      private const const_1000:int = 1;
      
      private const const_1766:int = 2;
      
      private const const_1765:int = 3;
      
      private const const_1767:int = 42;
      
      private const const_1768:int = 120;
      ...
      private var var_750:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this._soundManager.events.addEventListener(SongInfoReceivedEvent.const_87,this.onSongInfoReceivedEvent);
         this.var_409 = new Map();
         this.var_409.add(FurniModel.const_46,new FurniGridView(this.var_68,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_409.add(FurniModel.const_51,new FurniGridView(this.var_68,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._soundManager)
            {
               ...
               {
                  this._soundManager.events.removeEventListener(SongInfoReceivedEvent.const_87,this.onSongInfoReceivedEvent);
               }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_409.getValue(this.var_410);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_410);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_1000;
         }
         ...
         if(this.var_2199 == _loc2_)
         {
            return;
         }
         this.var_2199 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_410);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_345);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_311);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_331);
            ...
            if(_loc5_.category == FurniCategory.const_295)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_184)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_750 && this.var_750.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1103)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1768)
         {
            _loc3_ = this.const_1768;
         }
         else if(_loc3_ < this.const_1767)
         {
            _loc3_ = this.const_1767;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_376);
            }
         }
      }
