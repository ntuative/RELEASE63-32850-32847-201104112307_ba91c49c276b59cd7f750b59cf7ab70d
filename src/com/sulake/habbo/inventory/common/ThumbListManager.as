package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1499:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_93 = this.var_662.height;
         this.var_1237 = param5;
         this.var_1004 = param6;
         this.var_236 = Math.floor(this.var_1237 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1237,this.var_1004);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_236 * this._thumbWidth,this.var_1237),Math.max(this.var_663 * this.var_93,this.var_1004),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_236 && this.var_26.height < _loc3_.y * this.var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_236 - 1),this.var_93);
         ...
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_236 - 1),this.var_26.height - this.var_93);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1499.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_1004)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1004);
