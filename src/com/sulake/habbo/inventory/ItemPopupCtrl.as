package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_993:int = 5;
      
      private static const const_1385:int = 250;
      
      private static const const_1383:int = 100;
      
      private static const const_1384:int = 180;
      
      private static const const_1382:int = 200;
      ...
      {
         this.var_351 = new Timer(const_1385,1);
         this.var_350 = new Timer(const_1383,1);
         super();
         if(param1 == null)
         {
            return;
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1384,param3.width),Math.min(const_1382,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1820);
         switch(this.var_1820)
         {
            case const_1259:
               this.var_80.x = -1 * this.var_80.width - const_993;
               break;
            case const_471:
               this.var_80.x = this._parent.width + const_993;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1259:
               ...
               _loc2_.y = (this.var_80.height - this.var_960.height) / 2;
            ...
            case const_471:
               ...
               _loc2_.y = (this.var_80.height - this.var_774.height) / 2;
