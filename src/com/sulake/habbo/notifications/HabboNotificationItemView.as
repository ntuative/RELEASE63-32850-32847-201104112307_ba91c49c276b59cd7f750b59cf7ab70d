package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_901:int = 70;
      
      public static const const_570:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_613:int = 1;
      
      private static const const_973:int = 2;
      
      private static const const_974:int = 3;
      
      private static const const_437:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1680 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1680 = 15;
         }
         this.var_1681 = this._window.height;
         this.var_729 = 4;
         this.var_728 = 0;
         this._state = name_3;
         this.var_152 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_613:
               ...
               _loc2_ = Number(this.var_1127) / Number(this.var_414["time_fade_in"]);
               if(this.var_1127 > int(this.var_414["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_973:
               ...
               if(this.var_1377 > int(this.var_414["time_display"]) && !this.var_1679)
               {
                  this.startFadeOut();
               }
               break;
            case const_974:
               ...
               _loc3_ = 1 - Number(this.var_1126) / Number(this.var_414["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1126 > int(this.var_414["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1680;
         if(this._window.height < this.var_1681)
         {
            this._window.height = this.var_1681;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_152.method_1 == "TOP" ? int(const_437) : 0;
         var _loc4_:int = this.var_152.method_1 == "BOTTOM" ? int(_loc2_.height - const_437) : int(_loc2_.height);
         var _loc5_:int = this.var_152.method_1 == "LEFT" ? int(const_437) : 0;
         var _loc6_:int = this.var_152.method_1 == "RIGHT" ? int(_loc2_.width - const_437) : int(_loc2_.width);
         if(this.var_414["position_horizontal_follow_toolbar"] == "true" && (this.var_152.method_1 != "TOP" && this.var_152.method_1 != "BOTTOM"))
         {
            if(this.var_152.method_1 == "LEFT")
            {
               this._window.x = _loc5_ + const_570;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_570;
            }
         }
         else if(this.var_414["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_570;
         }
         else
         ...
         if(this.var_414["position_vertical_follow_toolbar"] == "true" && (this.var_152.method_1 != "RIGHT" && this.var_152.method_1 != "LEFT"))
         {
            if(this.var_152.method_1 == "TOP")
            {
               this._window.y = _loc3_ + this.var_729;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_729;
            }
         }
         else if(this.var_414["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_729;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_728;
      }
   }
}
