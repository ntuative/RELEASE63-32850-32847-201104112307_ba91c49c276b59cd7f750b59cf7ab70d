package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2757:IWindowContainer;
      
      private var var_2758:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1983 = IButtonWindow(this.find("bg_tab"));
         this.var_1982 = IButtonWindow(this.find("top_tab"));
         this.var_1984 = IButtonWindow(this.find("obj_tab"));
         this.var_2757 = IWindowContainer(this.find("tile_grid"));
         this.var_2758 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1983,this.onBgTabButton);
         Util.setProcDirectly(this.var_1982,this.onTopTabButton);
         Util.setProcDirectly(this.var_1984,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.mode = ThumbnailEditorModel.const_41;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1983,this.var_68.mode != ThumbnailEditorModel.const_41);
         this.setEnabled(this.var_1982,this.var_68.mode != ThumbnailEditorModel.const_61);
         this.setEnabled(this.var_1984,this.var_68.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2758;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_68.mode == ThumbnailEditorModel.const_41);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2757;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_521)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_518,HabboWindowStyle.const_45,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_296,HabboWindowStyle.const_45,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
