package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      {
         this.var_1028.visible = false;
         this.var_1999.visible = true;
         this.var_2779.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_839.setText(param1.eventDescription);
         this.var_910.setText(this.getTagFromEvent(param1,1));
         this.var_908.setText(this.getTagFromEvent(param1,2));
         this.var_1536.visible = false;
         this.var_1534.visible = true;
         this.var_1535.visible = true;
         this.var_2000.visible = false;
         this.var_1998.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_1028.visible = true;
         this.var_1999.visible = false;
         this.var_1536.visible = true;
         ...
         this.var_908.goBackToInitialState();
         this.var_1028.selection = 0;
         this.var_2000.visible = true;
         this.var_1998.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_1028.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_839.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_910.getText());
         this.addTag(_loc6_,this.var_908.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_839.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1999 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2779 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_2000 = ITextWindow(this.find("create_caption"));
            this.var_1998 = ITextWindow(this.find("edit_caption"));
            this.var_1536 = IButtonWindow(this.find("create_button"));
            this.var_1534 = IButtonWindow(this.find("edit_button"));
            this.var_2778 = IButtonWindow(this.find("cancel_button"));
            this.var_1535 = IButtonWindow(this.find("end_button"));
            this.var_1028 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1536,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1534,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1535,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2778,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_839 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_910 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_908 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
