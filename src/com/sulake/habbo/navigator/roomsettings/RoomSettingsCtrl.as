package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_595:ICheckBoxWindow;
      ...
      private var var_1109:IWindowContainer;
      ...
      {
         if(param1 != this.var_339 || this.var_1112 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1112 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1670)
         {
            this.var_724.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1592)
         {
            this.var_724.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1569)
         {
            this.var_1110.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1495)
         {
            this.setTagError(this.var_910,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_908,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1598)
         {
            ...
            this.setTagError(this.var_908,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1636)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_325,this.onDoorModePasswordSelect);
         ...
         this.var_908 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_909 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1105 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1113 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1108 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1107 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_595 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1666 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1372 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1111 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1109 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this._switchViewContainer = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1371 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_249 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1106 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2239 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2240 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1370 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1370.mouseThreshold = 0;
         this.var_1370.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1106.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1666.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2240.visible = this.var_492;
         this.var_2239.visible = !this.var_492;
         if(this.var_492)
         {
            this.var_1109.visible = true;
            this.var_1371.visible = false;
            this.refreshFlatControllers();
            this.var_1109.height = Util.getLowestPoint(this.var_1109) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1372.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1372.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1111.height = Util.getLowestPoint(this.var_1111) + 4;
         }
         this.var_1370.text = !!this.var_492 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1666.name,this.var_1372.name,this.var_1111.name,this.var_1109.name,this.var_1371.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.setTag(this.var_908,_loc1_.tags[1]);
         if(this.var_1113)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1108)
         {
            ...
            {
               this.var_1108.select();
            }
            else
            {
               this.var_1108.unselect();
            }
         }
         if(this.var_1107)
         {
            ...
            {
               this.var_1107.select();
            }
            else
            {
               this.var_1107.unselect();
            }
         }
         if(this.var_595)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_125)
         {
            ...
            _loc9_ = this.var_1105.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_909.clearErrors();
               this.var_1105.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1113.isSelected;
         _loc2_.allowFoodConsume = this.var_1108.isSelected;
         _loc2_.allowWalkThrough = this.var_1107.isSelected;
         _loc2_.hideWalls = this.var_595.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_910,_loc2_.tags);
         this.addTag(this.var_908,_loc2_.tags);
         this.clearErrors();
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_249.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_249.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_249.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_249.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_249.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_249.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_249.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_249);
         this.var_249.findChildByName("ruler").visible = true;
         ...
         if(this.var_75.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_249,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
