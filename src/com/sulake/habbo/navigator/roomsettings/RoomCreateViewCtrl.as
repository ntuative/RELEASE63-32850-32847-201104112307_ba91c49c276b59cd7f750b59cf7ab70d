package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1196:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1197:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_651 = new Timer(100);
         this.var_651.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_45 = new Array();
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,104,"a"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,94,"b"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,36,"c"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,84,"d"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"e"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,80,"f"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,416,"i"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,320,"j"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,448,"k"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,352,"l"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,384,"m"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_55,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_651)
         {
            this.var_651.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_651.reset();
            this.var_651 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1197.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1887 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1887 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_182 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_62 = IItemListWindow(this.var_182.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_182.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1196 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_182.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_182.desktop,this.var_182.width,this.var_182.height);
         this.var_182.x = _loc4_.x;
         this.var_182.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1196.goBackToInitialState();
         this.var_1196.input.textBackgroundColor = 4294967295;
         this.var_1197 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1196.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_182.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_182.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1196.getText();
         var _loc3_:String = "model_" + this.var_1197.name;
