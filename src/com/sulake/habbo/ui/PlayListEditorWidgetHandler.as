package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1548:IMessageEvent;
      
      private var var_2018:IMessageEvent;
      
      private var var_2017:IMessageEvent;
      ...
      {
         this.var_1548 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2018 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2017 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1548);
         this._connection.addMessageEvent(this.var_2018);
         this._connection.addMessageEvent(this.var_2017);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1548);
         this._connection.removeMessageEvent(this.var_2018);
         this._connection.removeMessageEvent(this.var_2017);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_866,RoomWidgetPlayListModificationMessage.const_655,RoomWidgetPlayListModificationMessage.const_809,RoomWidgetPlayListPlayStateMessage.const_702,RoomWidgetPlayListUserActionMessage.const_803];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_866:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_655:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_809:
            ...
            case RoomWidgetPlayListPlayStateMessage.const_702:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_803:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_276);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_276:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_864,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_815,-1));
            }
         }
      }
   }
