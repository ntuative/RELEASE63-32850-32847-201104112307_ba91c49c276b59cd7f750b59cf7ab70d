package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_877,RoomWidgetEcotronBoxOpenMessage.const_907,RoomWidgetEcotronBoxOpenedMessage.const_1490];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_877:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_907:
