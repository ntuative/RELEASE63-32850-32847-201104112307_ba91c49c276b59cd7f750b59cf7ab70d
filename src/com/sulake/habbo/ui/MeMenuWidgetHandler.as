   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_759,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_723,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_152 && !this.var_152.disposed && this.var_152.events)
            {
               this.var_152.events.removeEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_449,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_759,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_723,this.onHabboClubSubscriptionChanged);
         }
         this.var_152 = this._container.toolbar;
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_449,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            {
               _loc1_ = this.var_1767;
            }
         }
         if(this.var_152 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1185,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_152.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_768);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_836);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_788);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_786);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_869);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_709);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_426);
         _loc1_.push(RoomWidgetStopEffectMessage.const_954);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1482);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1215);
         _loc1_.push(RoomWidgetToolbarMessage.const_941);
         _loc1_.push(RoomWidgetToolbarMessage.const_752);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_374);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1668);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1139);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_892);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_939);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_902);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1541);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_684);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_739);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_823);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_412);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_939:
            ...
            case RoomWidgetWaveMessage.const_951:
               ...
               break;
            case RoomWidgetDanceMessage.const_768:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_836:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_788:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_786:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_426:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_709:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1072:
                        this._catalog.openCatalogPage(CatalogPageName.const_1608,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1107:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_336);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1617:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_80);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1633:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_954:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1215:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_892:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_941:
               ...
               if(this.var_152)
               {
                  this.var_152.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_752:
               ...
               {
                  this.var_152.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_581,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_374:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_902:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_408,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_684:
            ...
            case RoomWidgetStoreSettingsMessage.const_739:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_408,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_823:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_479));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_412:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_858));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_663));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_449:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_451));
         }
      }
