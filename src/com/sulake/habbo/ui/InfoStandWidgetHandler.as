   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_177,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_154,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_166,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_177,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_154,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_166,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_600.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_600.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_787);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_905);
         _loc1_.push(RoomWidgetUserActionMessage.const_712);
         _loc1_.push(RoomWidgetUserActionMessage.const_683);
         _loc1_.push(RoomWidgetUserActionMessage.const_950);
         ...
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_862);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1680);
         _loc1_.push(RoomWidgetPetCommandMessage.const_583);
         _loc1_.push(RoomWidgetPetCommandMessage.const_794);
         _loc1_.push(RoomWidgetUserActionMessage.const_563);
         _loc1_.push(RoomWidgetUserActionMessage.const_380);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_558)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_380 || param1.type == RoomWidgetUserActionMessage.const_563 || param1.type == RoomWidgetUserActionMessage.const_504)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_787:
            ...
            case RoomWidgetUserActionMessage.const_861:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_826,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_481:
               ...
               break;
            case RoomWidgetUserActionMessage.const_905:
            ...
            case RoomWidgetUserActionMessage.const_683:
               ...
               break;
            case RoomWidgetUserActionMessage.const_950:
            ...
            case RoomWidgetFurniActionMessage.const_781:
               ...
               break;
            case RoomWidgetUserActionMessage.const_380:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_915:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_862:
            ...
            case RoomWidgetUserActionMessage.const_679:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_794:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_291);
               _loc6_.id = param1.id;
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_348);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1240);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1173);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_881)
                  {
                     _loc31_ = this.var_69.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_424) == 0)
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_424.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_69.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_197)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_671)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_533);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_129)
               {
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_112)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_911);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1164;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1174;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1512);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_600.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_600.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_911);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_69 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_69.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
