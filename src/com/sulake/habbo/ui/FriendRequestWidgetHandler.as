package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_778);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_899);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_778:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_899:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_141);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_329);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_141:
            ...
            case FriendRequestEvent.const_329:
