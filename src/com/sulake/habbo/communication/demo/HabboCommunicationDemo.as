package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_548:IKeyExchange;
      
      private var var_1016:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2728:PseudoRandom;
      ...
      private var var_237:HabboHotelView;
      
      private var var_1519:String = "";
      
      private const const_1802:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_672 = param1;
            this.var_57.initConnection(HabboConnectionType.const_264);
         }
      }
      ...
      {
         if(this.var_57 && this.var_163 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_237 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_237.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_163.getKey("use.sso.ticket") == "1";
         this.var_672 = this.var_163.getKey("sso.ticket",null);
         this.var_1971 = this.var_163.getKey("flash.client.url","");
         this.var_2727 = this.var_163.getKey("external.variables.txt","");
         if(this.var_237 == null)
         {
            this.var_237 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_548,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1222;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_264);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_665);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2728 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_94:
               ...
               this.var_1519 = _loc4_;
               this.var_237.loadBannerImage(_loc7_ + "?token=" + this.var_1519,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1222:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1611:
               this.var_1016 = this.generateRandomHexString(30);
               this.var_548 = new DiffieHellman(new BigInteger(this.var_163.getKey("connection.development.prime"),16),new BigInteger(this.var_163.getKey("connection.development.generator"),16));
               this.var_548.init(this.var_1016);
               _loc8_ = this.var_548.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_548.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_548.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2728);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1520 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_252);
         connection.send(new VersionCheckMessageComposer(401,this.var_1971,this.var_2727));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1802,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2729)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1519);
         ...
         this.var_548 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_548.init(_loc14_);
            _loc15_ = this.var_548.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1016 = _loc14_;
            }
