package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1762:uint = 1;
      
      protected static const const_1759:uint = 2;
      
      protected static const const_1761:uint = 4;
      
      protected static const const_1760:uint = 3;
      ...
      public static const const_1192:Boolean = false;
      ...
      protected var var_241:URLRequest;
      ...
      protected var var_1071:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1070:Boolean = false;
      
      protected var var_2889:String = "";
      
      protected var var_2890:String = "";
      
      protected var var_2113:int;
      
      protected var var_1324:int;
      
      protected var var_1323:int;
      
      protected var var_2958:uint = 0;
      
      protected var var_2891:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_43.load(param1.var_241,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1192)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_852[_loc2_] as LibraryLoader;
            ...
            while(var_852.length < const_1654 && false)
            {
               _loc1_ = var_1055.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_852.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_241,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_241 ? this.var_241.url : null;
      }
      ...
      {
         return !!this.var_1071 ? uint(this.var_1324 - this.var_2113) : uint(getTimer() - this.var_2113);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_241.url);
      ...
      {
         if(this.var_1070 && !_disposed)
         {
            this.var_1070 = false;
            if(!this.var_1071 && this.var_241)
            {
               this.var_1324 = -1;
               this.var_2113 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1071 && !_disposed && this.var_1323 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_241,const_1529 - this.var_1323);
            if(this.var_2891)
            {
               this.var_241.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_241.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2891 = false;
            }
            --this.var_1323;
            this.var_475 = 0;
            this.var_43.load(this.var_241,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_475 == LibraryLoader.const_1760)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         if(this.var_610 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_241.url + "!");
            }
            return false;
         }
