package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1511:uint = 0;
      
      protected var var_284:Function;
      
      protected var var_1321:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_208 = new Timer(40,0);
            this.var_208.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_208.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1321 *= 0.75;
         this.var_1322 *= 0.75;
         if(Math.abs(this.var_1321) <= 1 && Math.abs(this.var_1322) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_284 != null)
         {
            this.var_284(this.var_1321,this.var_1322);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_208.stop();
            this.var_208.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_208 = null;
         }
         if(this._working)
         {
