package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_327:int = -2.147483648E9;
      ...
      {
         this.var_327 = param1;
         if(this.var_327 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_327)
         {
      ...
      {
         this.var_324 = param1;
         if(this.var_324 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_324)
         {
      ...
      {
         return this.var_327 == int.MIN_VALUE && this.var_326 == int.MAX_VALUE && this.var_324 == int.MIN_VALUE && this.var_325 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_327 = int.MIN_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_327)
            {
               this._target.width = this.var_327;
            }
            ...
            if(this._target.height < this.var_324)
            {
               this._target.height = this.var_324;
            }
