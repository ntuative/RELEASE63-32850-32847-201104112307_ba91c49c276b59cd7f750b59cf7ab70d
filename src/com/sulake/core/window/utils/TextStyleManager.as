package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_644:String = "{";
      
      private static const const_643:String = "}";
      
      private static const const_1434:String = "/*";
      
      private static const const_1435:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_205],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_205] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_545.indexOf(_loc4_.name) == -1)
            {
               var_545.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_643);
         if(countSubStrings(param1,const_644) != countSubStrings(param1,const_643))
         {
            throw new Error("Mismatching amount of \"" + const_644 + "\" versus \"" + const_643 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1434) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1435) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_644)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
