package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1123:String = "_EXCLUDE";
      
      public static const const_1903:String = "_INCLUDE";
      
      public static const const_1918:String = "_TEMP";
      
      private static const const_1333:String = "layout";
      
      private static const const_982:String = "window";
      
      private static const const_981:String = "variables";
      
      private static const const_983:String = "filters";
      
      private static const const_443:String = "name";
      
      private static const const_1342:String = "style";
      
      private static const const_622:String = "params";
      ...
      private static const const_1339:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1067:String = "blend";
      
      private static const const_1340:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1341:String = "treshold";
      
      private static const const_1332:String = "children";
      
      private static const const_1334:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1344:String = "height_min";
      
      private static const const_1338:String = "height_max";
      
      private static const const_621:String = "true";
      
      private static const const_173:String = "0";
      ...
      private static const const_1337:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1343:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1310:Dictionary;
      
      protected var var_1311:Dictionary;
      
      protected var var_1062:Dictionary;
      
      protected var var_1584:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1310,this.var_1311);
         this.var_1062 = new Dictionary();
         this.var_1584 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1062,this.var_1584);
         this.var_2094 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1343,const_49);
         return param1.replace(const_1337,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1310)
            {
               delete this.var_1310[_loc1_];
            }
            for(_loc1_ in this.var_1311)
            {
               delete this.var_1311[_loc1_];
            }
            for(_loc1_ in this.var_1062)
            {
               delete this.var_1062[_loc1_];
            }
            for(_loc1_ in this.var_1584)
            {
               delete this.var_1584[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         if(param1.localName() == const_1333)
         {
            ...
            _loc9_ = param1.child(const_983).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1310[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_443,variables,"")));
         style = uint(this.parseAttribute(xml,const_1342,variables,style));
         params = uint(this.parseAttribute(xml,const_622,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1335,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_173));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_173));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_173));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_173));
         visible = this.parseAttribute(xml,const_1331,variables,visible.toString()) == const_621;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_622).length() > 0)
         {
            list = xml.child(const_622).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_443,variables,"") as String;
               if(this.var_1062[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_443)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1339,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1336);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_981)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1334,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1344,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1338,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_621;
         blend = Number(this.parseAttribute(xml,const_1067,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1340,variables,window.clipping.toString()) == const_621;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1341,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_983).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1311[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1123) == -1)
                  {
