package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1624:uint = 0;
      
      public static const const_721:uint = 1;
      
      public static const const_1101:uint = 2;
      
      public static const const_807:uint = 4;
      
      public static const const_1590:uint = 8;
      
      public static const const_1616:uint = 16;
      
      public static const const_1961:uint = 64;
      
      public static const const_2018:uint = 128;
      
      public static const const_1049:uint = 256;
         ...
         if(this.var_863)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2101,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2101,16777215);
                  }
                  var_332 += bitmap.width * bitmap.height * 4;
               }
