package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1027:uint = 8;
      
      private static const const_1428:String = "skin";
      
      private static const const_1429:String = "bitmap";
      
      private static const const_1430:String = "fill";
      
      private static const const_1431:String = "text";
      
      private static const const_1432:String = "label";
      
      private static const const_1433:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1010 = new Dictionary();
         this.var_1965 = new Dictionary();
         this.var_2718 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1965,this.var_2718);
         this.var_2717 = new Dictionary();
         this.var_2716 = new Dictionary();
         StateCodeTable.fillTables(this.var_2717,this.var_2716);
         this.var_449 = new Dictionary();
         this.var_449[const_1428] = BitmapSkinRenderer;
         this.var_449[const_1429] = BitmapDataRenderer;
         this.var_449[const_1430] = FillSkinRenderer;
         this.var_449[const_1431] = TextSkinRenderer;
         this.var_449[const_1432] = LabelRenderer;
         this.var_449[const_1433] = ShapeSkinRenderer;
         this.var_449[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_449[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333.push(WindowState.const_65);
            var_333.push(WindowState.const_83);
            var_333.push(WindowState.const_100);
            var_333.push(WindowState.const_52);
            var_333.push(WindowState.const_96);
            var_333.push(WindowState.const_85);
            var_333.push(WindowState.const_107);
            var_333.push(WindowState.const_99);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2869 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.method_14(this.var_1965[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function method_14(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(this.var_1009[param1] == null)
         {
            this.var_1009[param1] = new Array(const_1027);
         }
         this.var_1009[param1][param2] = param3;
         if(this.var_1010[param1] == null)
         {
            this.var_1010[param1] = new Array(const_1027);
         }
         this.var_1010[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1009[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1010[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_183)
