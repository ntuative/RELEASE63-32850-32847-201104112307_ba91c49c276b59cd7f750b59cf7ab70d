package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_99:String = "default";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_394 = SkinLayoutEntity.const_544;
                  break;
               case "move":
                  _loc5_.var_394 = SkinLayoutEntity.const_318;
                  break;
               case "strech":
                  _loc5_.var_394 = SkinLayoutEntity.const_503;
                  break;
               case "tiled":
                  _loc5_.var_394 = SkinLayoutEntity.const_334;
                  break;
               case "center":
                  _loc5_.var_394 = SkinLayoutEntity.const_1092;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_544;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_318;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_503;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_334;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1092;
            }
         }
