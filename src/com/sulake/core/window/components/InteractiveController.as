package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1586 = PropertyDefaults.const_887;
         this.var_1316 = PropertyDefaults.const_414;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_414)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_214)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_414)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_789,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1507);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_887)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_852,param1.toolTipDelay,PropertyStruct.const_258,true));
         }
         else
         {
      ...
      {
         this.var_1316 = param1 == null ? "null" : param1;
      }
