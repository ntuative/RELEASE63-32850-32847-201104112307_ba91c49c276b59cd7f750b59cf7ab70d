package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1265:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_869:Number;
      ...
      protected var var_1069:Boolean = false;
      
      private var var_466:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_466,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_466 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_466,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_796 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_466);
      }
      ...
      {
         this.var_869 = param1;
         this._field.scrollH = this.var_869 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_869 * this.maxScrollH,this.var_571 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_466);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1197) ? new PropertyStruct(PropertyDefaults.const_830,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1253) : PropertyDefaults.const_1558);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1196 ? new PropertyStruct(PropertyDefaults.const_669,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1112) : PropertyDefaults.const_1606);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1165 ? new PropertyStruct(PropertyDefaults.const_1228,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1191) : PropertyDefaults.const_1704);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_764) ? new PropertyStruct(PropertyDefaults.const_396,this._field.textColor,PropertyStruct.const_157,true) : PropertyDefaults.const_1209);
         _loc1_.push(this.var_466 != TextStyleManager.const_205 ? new PropertyStruct(PropertyDefaults.const_400,this.var_466,PropertyStruct.const_53,true,PropertyDefaults.const_928) : PropertyDefaults.const_1145);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_678 ? new PropertyStruct(PropertyDefaults.const_275,this.var_42.left,PropertyStruct.const_43,true) : PropertyDefaults.const_458);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_756 ? new PropertyStruct(PropertyDefaults.const_237,this.var_42.top,PropertyStruct.const_43,true) : PropertyDefaults.const_609);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_888 ? new PropertyStruct(PropertyDefaults.const_241,this.var_42.right,PropertyStruct.const_43,true) : PropertyDefaults.const_554);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_833 ? new PropertyStruct(PropertyDefaults.const_274,this.var_42.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_482);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1249 ? new PropertyStruct(PropertyDefaults.const_838,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1694);
