package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1586:uint = 500;
      
      protected var var_1316:String = "";
      
      protected var var_1308:Boolean = false;
      
      protected var var_823:Boolean = false;
      ...
      {
         this.var_1316 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1101,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_823 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_384,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_364,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_932,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1715);
         _loc1_.push(this.var_1308 != PropertyDefaults.const_1126 ? new PropertyStruct(PropertyDefaults.const_726,this.var_1308,PropertyStruct.const_40,true) : PropertyDefaults.const_1733);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1131 ? new PropertyStruct(PropertyDefaults.const_743,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1681);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1069 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1727);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_726:
                  this.var_1308 = _loc2_.value as Boolean;
                  if(this.var_1308)
                  {
               ...
               case PropertyDefaults.const_932:
                  ...
                  break;
               case PropertyDefaults.const_1077:
