package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_293)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1115)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_866;
         if(this.var_866 != param1)
         {
            if(this.var_866 != null)
            {
               if(!this.var_866.disposed)
               {
                  this.var_866.deactivate();
               }
            }
            this.var_866 = param1;
