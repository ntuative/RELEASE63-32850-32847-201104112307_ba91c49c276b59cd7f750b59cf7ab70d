package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_466);
         if(_loc1_)
         {
      ...
      {
         if(this.var_466 != param1.name)
         {
            this.var_466 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2481 = _loc2_.textWidth;
         this.var_2482 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_347 != _loc2_.color : this.var_347 != null && this.var_347 != PropertyDefaults.const_764) ? new PropertyStruct(PropertyDefaults.const_396,this.var_347,PropertyStruct.const_157,true) : PropertyDefaults.const_1209);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_678)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,this.var_42.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_458);
            }
            if(this.var_42.top != PropertyDefaults.const_756)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,this.var_42.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_609);
            }
            if(this.var_42.right != PropertyDefaults.const_888)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,this.var_42.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_554);
            }
            if(this.var_42.bottom != PropertyDefaults.const_833)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,this.var_42.bottom,PropertyStruct.const_43,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_241:
                  ...
                  break;
               case PropertyDefaults.const_274:
                  if(this.var_42 || _loc2_.valid)
                  {
