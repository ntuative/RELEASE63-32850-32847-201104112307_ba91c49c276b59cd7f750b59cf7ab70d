package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_433:String = "_DROPMENU_TITLETEXT";
      ...
      {
         if(param1 > this.var_275.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_325,this,null,true);
      ...
      {
         return getChildByName(DropMenuController.const_433) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_190 == null || this.var_190.disposed)
         {
            this.var_190 = context.create(name + "::submenu","",WindowType.const_541,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_275.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1027 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1027)
         {
            if(this.open())
            {
               if(this.var_275.length)
               {
                  this.populateMenuItemContainer(this.var_275,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1027 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1027 = false;
            this.getTitleLabel().text = this.var_678 < this.var_275.length && this.var_678 > -1 ? this.var_275[this.var_678] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_508,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_427,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_678 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_678).setStateFlag(WindowState.const_52,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_868)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1129:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_847:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1550,this,null);
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1548,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_275[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_275.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_689,this.var_275,PropertyStruct.const_150,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1687);
         }
         return _loc1_;
      }
