package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1364:String = "_TITLE";
      
      private static const const_1365:String = "_HEADER";
      
      private static const const_1366:String = "_CONTENT";
      
      private static const const_1363:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1423:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1364) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1423 = findChildByTag(const_1365) as IHeaderWindow;
            if(!this.var_1423)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_182 = findChildByTag(const_1366) as IWindowContainer;
            if(!this.var_182)
            {
      ...
      {
         return findChildByTag(const_1363) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1264,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_327);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_241,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
