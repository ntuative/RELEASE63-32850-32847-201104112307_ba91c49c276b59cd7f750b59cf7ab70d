package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1280:IItemListWindow;
      
      private var var_459:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_459)
         {
            this.var_459.removeEventListener(WindowEvent.const_230,this.scrollBarEventProc);
            this.var_459.removeEventListener(WindowEvent.const_211,this.scrollBarEventProc);
            this.var_459 = null;
         }
         if(this.var_1280)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1280)
         {
            this.var_1280 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_459)
         {
            this.var_459 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_459)
            {
               this.var_459.addEventListener(WindowEvent.const_230,this.scrollBarEventProc);
               this.var_459.addEventListener(WindowEvent.const_211,this.scrollBarEventProc);
            }
         }
         return this.var_459;
      }
      ...
      {
         if(param1.type == WindowEvent.const_230)
         {
            this.showScrollBar();
         }
