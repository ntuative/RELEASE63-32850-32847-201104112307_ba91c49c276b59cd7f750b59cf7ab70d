package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1147:String = "AssetLibraryReady";
      
      public static const const_842:String = "AssetLibraryLoaded";
      
      public static const const_1686:String = "AssetLibraryUnloaded";
      
      public static const const_1565:String = "AssetLibraryLoadError";
      
      private static const const_443:String = "name";
      
      private static const const_979:String = "asset";
      
      private static const const_980:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_978:String = "library";
      
      private static var var_297:Dictionary;
      
      private static var var_1726:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_501:uint = 0;
      
      private static var var_933:Array = new Array();
      ...
      private var var_930:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_500 = new Dictionary(false);
         this.var_932 = new Dictionary(false);
         this.var_150 = new Dictionary(false);
         var_933.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_611 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_978);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_443);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_980);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_611 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_933.splice(var_933.indexOf(this),1);
            --var_501;
            this.var_500 = null;
            this.var_932 = null;
            this.var_150 = null;
      ...
      {
         if(this.var_611 == param1.url && this.var_931)
         {
            if(!this.var_930 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_610);
            }
            this.var_930 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1147));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_500)
         {
            _loc2_ = this.var_500[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_500[_loc1_];
         }
         for(_loc1_ in this.var_150)
         {
            delete this.var_150[_loc1_];
         }
         for(_loc1_ in this.var_932)
         {
         ...
         this.var_931 = false;
         this.var_611 = null;
         dispatchEvent(new Event(AssetLibrary.const_1686));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_932[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_500[param2.url];
         if(_loc4_ != null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_500[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_150[struct.assetName] == null)
                  {
                     ++this.var_418;
                     this.var_416.push(struct.assetName);
                  }
                  this.var_150[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_500[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_150[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_416.length ? this.getAssetByName(this.var_416[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_150)
         {
            if(this.var_150[_loc2_] == param1)
            {
               return this.var_416.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_150[param1] != null || (this.var_610 != null ? this.var_610[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_150[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1726.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_297.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_297[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_297[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_297)
            {
               _loc3_ = AssetTypeDeclaration(var_297[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_297)
            {
               _loc4_ = AssetTypeDeclaration(var_297[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_611 = _loc2_.url;
         if(this.var_930)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_610);
         }
         this.var_931 = true;
         dispatchEvent(new Event(AssetLibrary.const_842));
         dispatchEvent(new Event(AssetLibrary.const_1147));
         if(this.var_930)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1565));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_978);
         if(_loc2_ == null)
         {
