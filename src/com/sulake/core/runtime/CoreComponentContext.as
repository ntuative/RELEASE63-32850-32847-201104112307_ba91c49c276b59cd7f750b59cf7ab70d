package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1424:String = "asset-libraries";
      
      private static const const_1423:String = "library";
      
      private static const const_1425:String = "service-libraries";
      
      private static const const_1422:String = "library";
      
      private static const const_1421:String = "component-libraries";
      
      private static const const_1420:String = "library";
      
      private static const const_1419:String = "error_data";
      
      private static const const_1427:String = "error_cat";
      
      private static const const_1426:String = "error_desc";
       
      
      private var var_377:LibraryLoaderQueue;
      
      private var var_825:IEventDispatcher;
      
      private var var_542:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_272.push(new Array());
            this.var_670.push(0);
            _loc3_++;
         }
         this._lastUpdateTimeMs = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_397.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            ...
            case Core.const_782:
               ...
               var_397.addChild(new ProfilerViewer(this.var_211));
               break;
            case Core.const_545:
      ...
      {
         return this.var_542 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_272[i] as Array;
            ...
            if(var_397)
            {
               var_397.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
               var_397 = null;
            }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1419,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1427,String(param3));
         ErrorReportStorage.setParameter(const_1426,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_825 = loadingEventDelegate;
         if(this.var_377 == null)
         {
         ...
         try
         {
            node = config.child(const_1424)[0];
            if(node != null)
            {
               list = node.child(const_1423);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_346,e);
         }
         try
         {
            node = config.child(const_1425)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_346,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_346,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1559);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_825)
         {
            this.var_825.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_825)
         {
            ...
            this.var_825.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_825)
                  {
                     this.var_825.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_542 - this.var_377.length,this.var_542,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_211 ? 0 : this.var_1511 & 0;
         if(_loc3_ == Core.const_545)
         {
            this.var_272[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_272[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_211 ? 0 : this.var_1511 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_105)
         {
            _loc3_ = this.var_272[_loc5_] as Array;
            if(_loc4_ == Core.const_545)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_670[priority] = 0;
            receivers = this.var_272[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var maxTimePerFrame:uint = 1000 / var_397.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_105)
         {
            t = getTimer();
            ...
            {
               if(this.var_670[priority] < priority)
               {
                  ++this.var_670[priority];
                  skip = true;
               }
            }
            if(!skip)
