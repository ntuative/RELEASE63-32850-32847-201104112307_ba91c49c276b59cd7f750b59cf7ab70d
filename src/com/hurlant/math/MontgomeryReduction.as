package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1980 = param1.invDigit();
         this.var_1981 = this.var_1980 & 32767;
         this.var_2754 = this.var_1980 >> 15;
         this.var_2755 = 131071;
         this.var_2756 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_173) > 0)
         {
